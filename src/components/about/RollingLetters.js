  ...
  return (
    <div className="rolling-letters">
      <ul className="slides">
        <li></li>
        <li className="spacer">
          <svg viewBox="0 0 710 670" className="first-letter js-letter-anime">
            <image
              width="1451"
              height="1349"
        ...
        <li>
          <svg viewBox="0 0 590 670" className="js-letter-anime e-letter">
            <image
              width="1326"
              height="1366"
        ...
        <li>
          <svg viewBox="0 0 720 670" className="js-letter-anime a-letter">
            <image
              width="1453"
              height="1344"
        ...
        <li>
          <svg viewBox="0 0 710 670" className="js-letter-anime n-letter">
            <image
              width="1445"
              height="1348"
        ...
        <li>
          <svg viewBox="0 0 690 670" className="js-letter-anime o-letter">
            <image
              width="1422"
              height="1383"
