                  ...
                  <div className="hero-text row text-center align-center small-collapse">
                    <div className="xxlarge-9 medium-12 small-14 columns">
                      <h3 className="js-bigText-element">
                        Affinity is a consulting company specialised in
                        Technology and Information Systems. Or in Human
                        Relationships. It depends on who you ask.
                      ...
                      <div className="row expanded xxlarge-up-3 medium-up-2 xsmall-up-1">
                        ...
                        <div className="columns pos-rel values">
                          ...
                          <p>
                            ...
                            Our aim is to provide our employees with great
                            career opportunities, professional growth, and
                            fulfillment.{" "}
                            <span className="color-purple">
                  ...
                  <div className="row expanded">
                    <div className="xxlarge-4 xxlarge-offset-3 medium-6 medium-offset-1 xsmall-14 columns meta-title-wrapper">
                      ...
                      >
                        ...
                        <h3 className="subtitle js-text-element">
                          We work as a team. We are made of intend, competence
                          and ambition and we are driven by the will to exceed
                  ...
                  <div className="row expanded align-center align-bottom">
                    ...
                    <div className="xxlarge-6 xxlarge-offset-1 small-14 small-offset-0 columns">
                      ...
                      <p>
                        ...
                        <br />
                        <br />
                        We continue to invest in technological innovation, in
                        new working models, in a greater geographical expression
                        in Portugal, and in the creation of valuable experiences
                        for all our stakeholders.
                        <br />
                        <br />
                        We underline our ambition and reinforce our offer of IT
                        consulting services and quality Cloud products, at the
                        national and international level, promoting and
                        developing unique experiences that translate into a real
                        commitment to the creation of reciprocally prosperous
                        relationships with people, the market, society, and
                        nature.
                        <br />
                        <br />
                      ...
                      <ul role="list">
                        <li className="article Environment" data-id="0">
                          ...
                          <div className="article-content">
                            ...
                            <p>
                              ...
                              headed to an ecologically degraded area in Serra
                              de Sintra for a reforestation experience. The
                        ...
                        <li className="article Environment" data-id="1">
                          ...
                          <div className="article-content">
                            ...
                            <p>
                              ...
                              Caparica. As summer got to an end, beaches were
                              left with waste and plastics that will end up
                              polluting our oceans. We decided to take part of
                              the solution, getting our hands into work and
                              giving our small contribution towards a cleaner
                              ocean.
                            </p>
                            <button
                              role="button"
                        ...
                        <li className="article Environment" data-id="2">
                          ...
                          <div className="article-content">
                            ...
                            <p>
                              The intention to preserve our environment is
                              present in every decision we make. In the week we
                              returned to our office we offered a 'welcome kit'
                              to our employees with all the COVID-19 protection
                              taking this opportunity to also make a stand of
                              affinity for the environment. Our cotton bags will
                        ...
                        <li className="article Animal" data-id="3">
                          ...
                          <div className="article-content">
                            ...
                            <p>
                              ...
                              donations, but we spent our morning walking the
                              dogs around Sintra and sharing some beautiful and
                        ...
                        <li className="blue-block">
                          ...
                          <p>
                            ...
                            positive involvement on the main issues and
                            challenges happening around us.
                          </p>
                        </li>
                        <li className="article Children" data-id="5">
                          ...
                          <div className="article-content">
                            ...
                            <p>
                              ...
                              their choice thinking on a child up to 12 years
                              old, Affinity players were turn into the Secret
                              Santa of the children from Associação Acreditar
                            </p>
                            <button
                              role="button"
                              aria-label="Read the full article"
                        ...
                        <li className="article Environment" data-id="6">
                          ...
                          <div className="article-content">
                            ...
                            <p>
                              All Affinity employees, are welcomed to the
                              company with a kit that includes a reusable water
                              bottle. Our aim is to inspire and promote the
                              fight against plastic contamination in their
                        ...
                        <li className="gray-block">
                          <p>
                            We assume an active approach towards the protection
                        ...
                        <li className="article Children" data-id="8">
                          ...
                          <div className="article-content">
                            ...
                            <p>
                              ...
                              organization that protects and cares for babies
