          ...
          <div class="page-main page-current">
            ...
            >
                ...
                <div class="navbar-services-wrapper">
                  <div class="row align-center">
                    <div class="xxlarge-16">
                      <div class="row align-center">
                        <div class="xxlarge-12 medium-14 small-16">
                          <div class="navbar-services-scroll">
                            <ul class="navbar-services row xxlarge-up-3  software-active">
              ...
              <h3 class="subtitle js-text-element">Equipa são todos os que vestem a camisola e também os que nos ajudam a querer mantê-la.</h3> */}
                ...
                <section class="technologies js-hashtag-scroll">
                  <div class="row align-center">
                    <div class="xxlarge-12 small-13 xsmall-14 text-center">
                      <h2 class="hashtag-title js-write-text">
                        #Service Oriented Solutions
                      </h2>
                    </div>
                  </div>
                  <div class="row align-center">
                    <ul class="xxlarge-12 row xxlarge-up-5 medium-13 small-14 xsmall-16 medium-up-3 small-up-2">
                      <li
                        class="column"
                ...
                <footer class="page-footer type-1">
                  ...
                  <div class="row expanded last-content-wrapper xsmall-collapse">
                    <div class="xxlarge-2 xxlarge-offset-1 medium-3 small-6 small-offset-0 xsmall-5 columns made-by">
                      <a href="../../privacy-policy/index.html" target="_blank">
                        <h4>Privacy Policy </h4>{" "}
                      </a>
                      {/* <h4>2023 &copy; Affinity</h4> */}
                    </div>
                    <div class="xxlarge-10 medium-8 small-4 xsmall-16 columns text-center">
                      <a
                        href="../../index.html"
                        data-remote="true"
                      ...
                      >
                        <svg class="main-logo" viewBox="0 0 1566.1 460.4">
                    ...
                    <div class="xxlarge-2 medium-3 small-6 xsmall-5 columns affinity-mark">
                      <ul>
                        <li>
                          <a
