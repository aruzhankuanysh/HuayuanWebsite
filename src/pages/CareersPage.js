              ...
              <div className="hero-text row text-center align-center small-collapse">
                <div className="xxlarge-10 medium-12 small-14 columns">
                  <h3 className="js-bigText-element">
                    <i>A Lifetime Experience</i> is the way we do things. During
                    your journey at Affinity, we will always work to contribute
                    to your fulfilment, wellbeing and growth. Our main goal is
                    that, regardless of the time you spend with us, this is
                    always a positive and constructive part of your life and
                    career.
                  </h3>
                </div>
              </div>
