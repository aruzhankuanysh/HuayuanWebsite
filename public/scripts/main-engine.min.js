  ...
  function Ee() {
    switch (t) {
      case "home":
        ...
        container.append(
          '<div class="webgl-fallback"><img src="/public/obj/imgFallBack/home.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "about":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/public/obj/imgFallBack/about.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "contact":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/public/obj/imgFallBack/contact.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "jobs":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/public/obj/imgFallBack/jobs.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "nearshoring":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/public/obj/imgFallBack/near.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "software":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/public/obj/imgFallBack/soft.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "outsourcing":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/public/obj/imgFallBack/out.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
...
function fazemosPage(e) {
  ...
  function p() {
    ...
    t.add(
      "nearshoring_0",
      "/public/imgs/nearshoring/menu/menu-nearshoring@2x_0.png"
    );
    t.add(
      "outsourcing_0",
      "/public/imgs/outsourcing/menu/menu-outsourcing@2x_0.png"
    );
    ...
    t.load(function () {
      ...
      for (i = 0; i < l.total_frames; i++) {
        n.add(
          "nearshoring_" + i,
          "/public/imgs/nearshoring/menu/menu-nearshoring@2x_" + i + ".png"
        );
      }
      for (i = 0; i < c.total_frames; i++) {
        n.add(
          "outsourcing_" + i,
          "/public/imgs/outsourcing/menu/menu-outsourcing@2x_" + i + ".png"
        );
      }
      for (i = 0; i < f.total_frames; i++) {
        n.add(
          "software_" + i,
          "/public/imgs/software/menu/menu-software@2x_" + i + ".png"
        );
      }
      n.load(function () {
        h();
    ...
    if (!_browserObj.isPhone) {
      ...
      e.on("click", function () {
        ...
        if ($_body.hasClass("pt-lang")) {
          $(".full-video")
            .find("video source")
            .attr("src", "/public/video/" + e + "-full-pt.mp4");
        } else {
          $(".full-video")
            .find("video source")
            .attr("src", "/public/video/" + e + "-full.mp4");
        }
      ...
      e.on("click", function () {
        ...
        if (i) {
          ...
          $(".full-video")
            .find("video source")
            .attr("src", "/public/video/" + e + "-mobile.mp4");
          TweenMax.to(".full-video", 1, { opacity: 1, ease: "Expo.easeInOut" });
          $(".full-video").find("video")[0].load();
          $(".full-video").find("video")[0].play();
        } else {
