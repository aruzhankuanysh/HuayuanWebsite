var disableBodyScroll = (function () {
  ...
  return function (e, t) {
    ...
    if (true === e) {
      if (false !== o) {
        o.addEventListener("touchstart", s, { passive: false });
        o.addEventListener("touchmove", r, { passive: false });
      }
      $("body, html").css("overflow", "hidden");
      document.body.addEventListener("touchmove", n, { passive: false });
    } else {
      if (false !== o) {
        o.removeEventListener("touchstart", s, { passive: false });
        o.removeEventListener("touchmove", r, { passive: false });
      }
      $("body, html").css("overflow", "");
      document.body.removeEventListener("touchmove", n, { passive: false });
    }
  };
})();
function GlAnimation(h) {
  ...
  var e,
    ...
    z = Math.cos,
    W = Math.sin,
    q = new TimelineMax({ paused: true }),
    X = new TimelineMax({ paused: true }),
    N = new TimelineMax({ paused: true }),
    U = new TimelineMax({ paused: true }),
    Z = new TimelineMax({ paused: true }),
    J = new TimelineMax({ paused: true }),
    Q = new TimelineMax({ paused: true }),
    K = new TimelineMax({ paused: true }),
    ee = new TimelineMax({ paused: true }),
    te = new TimelineMax({ paused: true }),
    ae = new THREE.Vector3(0, 0, 0);
  var oe = new THREE.LoadingManager();
  var ie = new THREE.JSONLoader(oe),
    ne = new THREE.TextureLoader(oe),
    se = new TimelineMax({ paused: true }),
    re = new THREE.Clock(),
    le = re.getDelta(),
  ...
  var ce = h.mouseInfluence,
    ...
    ue = 5,
    H = 30;
  var he = "./imgs/studio_1/",
    me = "./imgs/studio_2/";
  var ge = ne.load("./obj/tex/lightMap.jpg");
  var we = function () {
    ...
    if (D <= h.desktopMaxWidth) {
      ...
      x.scale.set(a, a, a);
      x.position.set(
        h.objGroupX_MaxDesktop,
        h.objGroupY_MaxDesktop,
        h.objGroupZ_MaxDesktop
      );
      if (typeof y !== "undefined") {
        y.scale.set(
      ...
      x.scale.set(a, a, a);
      x.position.set(
        h.objGroupX_bigDesktop,
        h.objGroupY_bigDesktop,
        h.objGroupZ_bigDesktop
      );
      if (typeof y !== "undefined") {
        y.scale.set(
          h.objText_ScaleBigDesktop,
          h.objText_ScaleBigDesktop,
          h.objText_ScaleBigDesktop
        );
      }
  ...
  function Ee() {
    switch (t) {
      case "home":
        ...
        container.append(
          '<div class="webgl-fallback"><img src="/obj/imgFallBack/home.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "about":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/obj/imgFallBack/about.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "contact":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/obj/imgFallBack/contact.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "jobs":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/obj/imgFallBack/jobs.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "nearshoring":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/obj/imgFallBack/near.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "software":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/obj/imgFallBack/soft.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
      ...
      case "outsourcing":
        container = $(".page-header #webGL-container");
        container.append(
          '<div class="webgl-fallback"><img src="/obj/imgFallBack/out.png)" alt="Webgl Fallback"></div>'
        );
        TweenMax.fromTo(
          container,
          0.5,
  ...
  var Ae = function () {
    l = new THREE.Scene();
    i = new THREE.PerspectiveCamera(45, D / A, 0.1, 1e3);
    n = Oe()
  ...
  // function Ve() {
  //   ie.load("./obj/objHome.json", function (e, t) {
  ...
  //     v = THREE.AnimationClip.CreateFromMorphTargetSequence(
  //       "letterMorph",
  //       m.geometry.morphTargets,
  //       1,
  //       true
  //     );
  ...
  //       h.aniTimeFadeIn,
  //       { opacity: 0 },
  //       { opacity: 0.95, ease: Power1.easeOut },
  //       0
  //     );
  //     TweenMax.fromTo(
  //       m.position,
  ...
  // }
  // function Re() {
  //   ie.load("./obj/objAbout.json", function (e, t) {
  //     t = new THREE.MeshStandardMaterial({
  //       color: 8740564,
  //       envMap: Ce,
  //       envMapIntensity: 1,
  ...
  // }
  // function Ge() {
  //   ie.load("./obj/objContact.json", function (e, t) {
  //     t = new THREE.MeshStandardMaterial({
  //       color: 16215662,
  //       envMap: Ce,
  //       envMapIntensity: 1,
  ...
  // }
  // function Be() {
  //   ie.load("./obj/obJobs.json", function (e, t) {
  //     t = new THREE.MeshStandardMaterial({
  //       color: 1880203,
  //       envMap: Ce,
  //       envMapIntensity: 0.6,
  ...
  // }
  // function Ye() {
  //   var e = "./obj/objNear.json",
  //     t = "./obj/text.json",
  //     a = "./obj/owl.json";
  //   var o = ne.load("./obj/tex/colorMapOwl.jpg"),
  //     i = ne.load("./obj/tex/lightMapOwl.jpg"),
  //     n = ne.load("./obj/tex/transMapOwl.jpg"),
  //     s = ne.load("./obj/tex/colorMapTrunk.jpg"),
  //     r = ne.load("./obj/tex/transMapTrunk.jpg");
  ...
  //     typeMovement = 10;
  //     var a = [
  //       y.skeleton.bones[1].position,
  //       y.skeleton.bones[2].position,
  //       y.skeleton.bones[3].position,
  //       y.skeleton.bones[4].position,
  //       y.skeleton.bones[5].position,
  //       y.skeleton.bones[6].position,
  //       y.skeleton.bones[7].position,
  //       y.skeleton.bones[8].position,
  //       y.skeleton.bones[9].position,
  //     ];
  //     Q.fromTo(
  //       y.position,
  //       h.aniTimeLoop * 0.25,
  //       { y: -3 },
  //       { y: 4.5, ease: Power1.easeOut },
  //       "start -= 0"
  //     )
  //       .fromTo(
  //         y.material,
  ...
  //         a,
  //         h.aniTimeLoop,
  //         { y: 0.18, ease: Power1.easeInOut, repeat: -1, yoyo: true },
  //         0.5,
  //         "loop -= 6"
  //       );
  //   });
  ...
  // }
  // function ze() {
  //   var e = "./obj/leftHand.json",
  //     t = "./obj/textSoft.json",
  //     a = "./obj/objSoft.json";
  //   var o = ne.load("./obj/tex/colorMapLeftHand.jpg"),
  //     i = ne.load("./obj/tex/transMapLeftHand.jpg"),
  //     n = ne.load("./obj/tex/lightMapHand.jpg");
  //   ie.load(t, function (e, t) {
  //     objTextMaterial = new THREE.MeshBasicMaterial({
  //       skinning: true,
  //       color: 0,
  ...
  // }
  // function We() {
  //   var e = "./obj/objOut.json",
  //     t = "./obj/textOut.json",
  //     a = "./obj/suri.json";
  //   var o = ne.load("./obj/tex/lightMapsuri.jpg"),
  //     i = ne.load("./obj/tex/colorMapSuri.jpg"),
  //     n = ne.load("./obj/tex/transMapSuri.jpg");
  //   ie.load(t, function (e, t) {
  //     objTextMaterial = new THREE.MeshBasicMaterial({
  //       skinning: true,
  //       color: 0,
  ...
  //       y.skeleton.bones[8].position,
  //       y.skeleton.bones[9].position,
  //       y.skeleton.bones[10].position,
  //       y.skeleton.bones[11].position,
  //     ];
  //     Q.fromTo(
  //       y.position,
  //       h.aniTimeLoop * 0.25,
  ...
  //     TweenMax.to(objExtra1.skeleton.bones[11].position, 0.08, {
  //       x: xe(a, -0.2585, -0.2285, -L, L),
  //       y: xe(o, 0.145, 0.165, -I, I),
  //       ease: Power4.easeOut,
  //     });
  //     TweenMax.to(objExtra1.skeleton.bones[12].position, 0.08, {
  //       x: xe(a, 0.2285, 0.2585, -L, L),
  //       y: xe(o, 0.145, 0.165, -I, I),
  //       ease: Power4.easeOut,
  //     });
  //   }
  ...
  //   e.paused = false;
  //   q.pause();
  //   N.to(m.rotation, h.aniTime, { y: ye(95), ease: Power2.easeInOut })
  //     .to(m.rotation, h.aniTime * 1.15, { y: ye(85), ease: Power1.easeInOut })
  //     .to(m.rotation, h.aniTime * 0.9, {
  //       y: ye(90),
  ...
  //   e.paused = false;
  //   q.pause();
  //   N.to(m.rotation, h.aniTime, { y: ye(120), ease: Power1.easeOut })
  //     .to(m.rotation, h.aniTime * 0.7, { y: ye(75), ease: Power1.easeOut })
  //     .to(m.rotation, h.aniTime * 0.9, {
  //       y: ye(90),
  //       ease: Power2.easeOut,
  //       onComplete: function () {
  ...
  //   var e = w.clipAction(v);
  //   e.paused = false;
  //   TweenMax.to(m.material, h.aniTime, { envMapIntensity: 0.7 });
  //   N.to(m.rotation, h.aniTime, { y: ye(120), ease: Power1.easeInOut })
  //     .to(m.rotation, h.aniTime * 0.7, { y: ye(75), ease: Power1.easeInOut })
  //     .to(m.rotation, h.aniTime * 0.9, {
  //       y: ye(90),
  ...
  //   e.paused = false;
  //   q.pause();
  //   N.to(m.rotation, h.aniTime, { x: ye(10), y: ye(5), ease: Power1.easeInOut })
  //     .to(m.rotation, h.aniTime * 0.6, {
  //       x: ye(-10),
  //       y: ye(-5),
  //       ease: Power1.easeInOut,
  //     })
  //     .to(m.rotation, h.aniTime * 0.7, {
  //       x: ye(0),
  //       y: ye(0),
  //       ease: Power2.easeInOut,
  //       onComplete: function () {
  ...
  var rt = function () {
    ...
    q.fromTo(
      ...
      h.aniTimeLoop,
      { x: -0.7, y: 0 },
      { x: 0.7, y: 3, ease: Power1.easeInOut, repeat: -1, yoyo: true }
    );
    TweenMax.fromTo(
      objNew.material,
      0.4,
      { opacity: 0 },
      { opacity: 0.95, ease: Power1.easeInOut },
      0
    );
    TweenMax.fromTo(
      objNew.position,
  ...
  //   var e = w.clipAction(v);
  //   e.paused = false;
  //   N.to(objNew.rotation, h.aniTime * 0.5, {
  //     x: ye(6),
  //     y: ye(5),
  //     ease: Power1.easeInOut,
  //   })
  //     .to(objNew.rotation, h.aniTime * 0.5, {
  //       x: ye(-4),
  //       y: ye(-5),
  //       ease: Power1.easeInOut,
  //     })
  //     .to(objNew.rotation, h.aniTime * 0.6, {
  //       x: ye(0),
  //       y: ye(0),
  //       ease: Power1.easeInOut,
  //     });
  ...
  var ct = function () {
    ...
    wingAngle = 10;
    // var t = [
    //   objExtra1.skeleton.bones[1].rotation,
    //   objExtra1.skeleton.bones[2].rotation,
    //   objExtra1.skeleton.bones[3].rotation,
    //   objExtra1.skeleton.bones[4].rotation,
    // ];
    // var a = [
    //   objExtra1.skeleton.bones[5].rotation,
    //   objExtra1.skeleton.bones[6].rotation,
    //   objExtra1.skeleton.bones[7].rotation,
    //   objExtra1.skeleton.bones[8].rotation,
    // ];
    ...
    N.fromTo(
      ...
      .to(m.rotation, h.aniTime, { y: ye(95), ease: Power1.easeInOut })
      .to(m.rotation, h.aniTime * 0.8, { y: ye(85), ease: Power1.easeInOut })
      .to(m.rotation, h.aniTime * 0.9, {
        y: ye(90),
        ease: Power2.easeInOut,
        onComplete: function () {
      ...
      .to(
        objExtra1.position,
        h.aniTime * 1.5,
        { y: 0, z: 65, ease: Power2.easeOut },
        "owl-=2.5"
      )
      .staggerFromTo(
        a,
        1,
        { z: -ye(15), ease: Power1.easeOut },
        { z: ye(15), ease: Power1.easeOut },
        0.2,
        "wing-=2.5"
      )
      ...
      .to(
        objExtra1.position,
        h.owlAniTime,
        { y: -1.5, ease: Power1.easeInOut, repeat: -1, yoyo: true },
        "wingloop-=1.3"
      )
      .staggerTo(
        a,
        h.owlAniTime,
        { y: ye(5), z: ye(0), ease: Power2.easeInOut, repeat: -1, yoyo: true },
        0.2,
        "wingloop-=1.5"
      )
      .staggerTo(
      ...
      .fromTo(
        objExtra1.skeleton.bones[9].rotation,
        h.owlAniTime,
        { x: -ye(20), z: ye(5) },
        {
          x: -ye(35),
      ...
      .fromTo(
        objExtra1.skeleton.bones[10].rotation,
        h.owlAniTime,
        { x: -ye(20), z: ye(5) },
        {
          x: -ye(35),
  ...
  var ft = function () {
    ...
    wingAngle = 10;
    // var t = [
    //   objLeftHand.skeleton.bones[4].rotation,
    //   objLeftHand.skeleton.bones[5].rotation,
    // ];
    // var a = [
    //   objLeftHand.skeleton.bones[6].rotation,
    //   objLeftHand.skeleton.bones[7].rotation,
    //   objLeftHand.skeleton.bones[8].rotation,
    // ];
    // var o = [
    //   objLeftHand.skeleton.bones[9].rotation,
    //   objLeftHand.skeleton.bones[10].rotation,
    //   objLeftHand.skeleton.bones[11].rotation,
    // ];
    // var i = [
    //   objLeftHand.skeleton.bones[12].rotation,
    //   objLeftHand.skeleton.bones[13].rotation,
    //   objLeftHand.skeleton.bones[14].rotation,
    // ];
    // var n = [
    //   objLeftHand.skeleton.bones[15].rotation,
    //   objLeftHand.skeleton.bones[16].rotation,
    //   objLeftHand.skeleton.bones[17].rotation,
    // ];
    // var s = [
    //   objLeftHand.skeleton.bones[1].rotation,
    //   objLeftHand.skeleton.bones[2].rotation,
    //   objLeftHand.skeleton.bones[3].rotation,
    // ];
    // var r = [
    //   objRightHand.skeleton.bones[4].rotation,
    //   objRightHand.skeleton.bones[5].rotation,
    // ];
    // var l = [
    //   objRightHand.skeleton.bones[6].rotation,
    //   objRightHand.skeleton.bones[7].rotation,
    //   objRightHand.skeleton.bones[8].rotation,
    // ];
    // var c = [
    //   objRightHand.skeleton.bones[9].rotation,
    //   objRightHand.skeleton.bones[10].rotation,
    //   objRightHand.skeleton.bones[11].rotation,
    // ];
    // var f = [
    //   objRightHand.skeleton.bones[12].rotation,
    //   objRightHand.skeleton.bones[13].rotation,
    //   objRightHand.skeleton.bones[14].rotation,
    // ];
    // var d = [
    //   objRightHand.skeleton.bones[15].rotation,
    //   objRightHand.skeleton.bones[16].rotation,
    //   objRightHand.skeleton.bones[17].rotation,
    // ];
    // var p = [
    //   objRightHand.skeleton.bones[1].rotation,
    //   objRightHand.skeleton.bones[2].rotation,
    //   objRightHand.skeleton.bones[3].rotation,
    // ];
    ...
    //   })
    //   .to(
    //     objLeftHand.material,
    //     h.aniTime * 0.9,
    //     { opacity: 1, ease: Power2.easeOut },
    //     "owl-=2.5"
    //   )
    //   .to(
    //     objRightHand.material,
    //     h.aniTime * 0.9,
    //     { opacity: 1, ease: Power2.easeOut },
    //     "owl-=2.5"
    //   )
    //   .to(
    //     objLeftHand.position,
    //     h.aniTime * 1.5,
    //     { y: 0, x: 12, z: 45, ease: Power2.easeOut },
    //     "owl-=2.5"
    //   )
    //   .to(
    //     objRightHand.position,
    //     h.aniTime * 1.5,
    //     { y: 0, x: -12, z: 45, ease: Power2.easeOut },
    //     "owl-=2.5"
    //   )
    ...
    //     objLeftHand.position,
    //     h.extra1Animation,
    //     { y: 2, ease: Power1.easeInOut, repeat: -1, yoyo: true },
    //     "wingloop-=1.3"
    //   )
    //   .to(
    //     objRightHand.position,
    ...
    //     t,
    //     h.extra1Animation,
    //     { x: ye(2), z: -ye(2), ease: Power1.easeInOut, repeat: -1, yoyo: true },
    //     0.2,
    //     "wingloop-=1.5"
    //   )
    //   .staggerTo(
    ...
    //     n,
    //     h.extra1Animation,
    //     { x: ye(6), z: -ye(3), ease: Power1.easeInOut, repeat: -1, yoyo: true },
    //     0.2,
    //     "wingloop-=1.5"
    //   )
    //   .staggerTo(
    ...
    //     s,
    //     h.extra1Animation,
    //     { x: -ye(5), z: ye(2), ease: Power1.easeInOut, repeat: -1, yoyo: true },
    //     0.2,
    //     "wingloop-=1.5"
    //   )
    //   .staggerTo(
  ...
  var dt = function () {
    ...
    function r() {
      ...
      TweenMax.staggerTo(
        a,
        t,
        { z: ye(e), y: ye(e * 1.2), ease: Power4.easeInOut },
        0.01,
        function () {
          r();
        }
      );
      TweenMax.to(o, t, { z: ye(e), y: ye(e * 1.2), ease: Power4.easeInOut });
    ...
    //     "nStart -= 0"
    //   )
    //   .to(m.rotation, h.aniTime, { y: ye(95), ease: Power1.easeOut })
    //   .to(m.rotation, h.aniTime * 0.8, { y: ye(85), ease: Power1.easeOut })
    //   .to(m.rotation, h.aniTime * 0.9, {
    //     y: ye(90),
    //     ease: Power2.easeOut,
    //     onComplete: function () {
    ...
    N.staggerFromTo(
      a,
      h.extra1Animation * 1.5,
      { z: ye(0), y: ye(0), ease: Power3.easeOut },
      { z: ye(-0.7), y: ye(-4), ease: Power3.easeOut },
      0.1,
      "start-=0",
      r
    )
      .staggerFromTo(
        o,
        h.extra1Animation * 1.3,
        { z: 0, ease: Power3.easeOut },
        { z: -ye(4.5), y: -ye(4.5), ease: Power3.easeOut },
        0.2,
        "start-=0"
      )
      .fromTo(
        ...
        { x: -0.3, ease: Power3.easeOut },
        "start-=0"
      )
      .to(
        i,
        h.extra1Animation * 0.85,
        {
          x: 1.08,
          y: 1.08,
          z: 1.08,
      ...
      .staggerFromTo(
        n,
        h.extra1Animation * 1.3,
        { z: ye(0), y: ye(0), ease: Power4.easeOut },
        { z: ye(-0.7), y: ye(-3), ease: Power4.easeOut },
        0.2,
        "start-=0",
        l
      )
...
function globalStickyHeader() {
  ...
  if (_customScroll == null) {
    ...
    $_window[0].addEventListener("scroll", t, { passive: true });
    var a = { offset: { y: -1 } };
...
function statisticsAnimation() {
  var e = $(".statistics");
  var t = { rootMargin: "0px", threshold: [0] };
  var a = function (e, t) {
...
function hoverLinksMenu() {
  ...
  var i = function (e, t) {
    var a = e.find(".char"),
      o = e.attr("data-color");
    if (t == "in") {
      TweenMax.staggerTo(a, 1, { color: o, ease: Expo.easeOut }, 0.05);
    } else {
      if (!$_body.hasClass("home")) {
        TweenMax.staggerTo(
          a,
          1,
          { color: "#9fa6b6", ease: Expo.easeOut },
          0.05
        );
      } else {
        if (!$("#header-main").hasClass("js-drop")) {
          TweenMax.staggerTo(
            a,
            1,
            { color: "#ffffff", ease: Expo.easeOut },
            0.05,
            function () {
              TweenMax.set(a, { clearProps: "color" });
            }
          );
        } else {
          TweenMax.staggerTo(
  ...
  return { init: o, hover: i };
}
function setupDomElements(e) {
  switch (e) {
    case "single-service":
      if (!$_body.hasClass("mobile")) {
        breakTitleLetters($_pageHeader.find("h1"));
        TweenMax.set($_pageHeader.find("h1 .char"), { y: "100px", opacity: 0 });
        TweenMax.set($_pageHeader.find(".letter-wrapper"), {
          opacity: 0,
          scale: 0.85,
        });
        TweenMax.set($_pageHeader.find(".js-pet"), { opacity: 0, scale: 0.85 });
        TweenMax.set($_pageHeader.find(".background-image"), { opacity: 0 });
      }
    ...
    case "somos":
      $(".affinity-brands .block-wrapper").each(function () {
        ...
        e.find(".gradient-block").data(
          "real-height-gradient",
          e.find(".gradient-block").height()
        );
    ...
    // case "queremos":
      ...
      //   x:
      //     _globalViewportW / 2 -
      //     $(".navbar-job-filter-wrapper .btn-wrapper").width() / 2 -
      //     $(
      //       ".navbar-job-filter-wrapper .btn-wrapper .open-filter .morph-bg"
      //     )[0].getBoundingClientRect().width /
      //       2,
      // });
      // $(".navbar-job-filter-wrapper").data(
      //   "height-block",
      //   $(".navbar-job-filter-wrapper").outerHeight()
      // );
      // $(".navbar-job-filter-wrapper .btn-wrapper .open-filter").data(
      //   "path-width",
      //   $(
      //     ".navbar-job-filter-wrapper .btn-wrapper .open-filter .morph-bg"
      //   )[0].getBoundingClientRect().width / 2
      // );
      // TweenMax.set($(".navbar-job-filter-wrapper"), { height: "91px" });
      // TweenMax.set(
      //   $(".navbar-job-filter").find(".option-wrapper:not(.active-option)"),
      //   { y: "10px", autoAlpha: 0 }
      // );
      // break;
    case "noticias":
        ...
        if (!$_body.hasClass("mobile")) {
          if (!$_html.hasClass("edge") && !$_html.hasClass("ie")) {
            TweenMax.set($(".nav-sidebar"), {
              top:
                $(".full-page-article .full-page-article-image").offset().top +
                "px",
            });
          }
        } else {
  ...
  if (!$_body.hasClass("mobile")) {
    TweenMax.set($_pageHeader.find("h1"), { opacity: 0 });
    TweenMax.set($_pageHeader.find("h2"), { opacity: 0 });
  }
}
function readProgress() {
  var i = $(".scroll-indicator-wrapper"),
    ...
    e =
      $(".nav-sidebar-item").eq(0).offset().top -
      $(".nav-sidebar").offset().top,
    ...
    f = 0;
  var d = function () {
    TweenMax.set(i, { y: e, height: t - 4, top: "2px" });
    TweenMax.set(n, { scaleY: 0 });
    s = $(".full-page-article").eq(0);
    l = $(".full-page-article").eq(0).outerHeight();
    o = _rAF_loop(h);
    h();
  ...
  var p = function (e, t, a) {
    c = true;
    var o =
      $(".nav-sidebar-item").eq(e).offset().top -
      $(".nav-sidebar").offset().top +
      a;
    ...
    if (_scrollDirection == "down") {
      ...
      TweenMax.to(i, 1, { y: o, ease: Expo.easeOut });
    } else {
      TweenMax.to(n, 1, {
        scaleY: 1,
  ...
  return { init: d, changeNew: p, kill: u };
}
function initForm(e) {
  var n = e,
    ...
    if (a)
      if (a.type.indexOf("pdf") !== -1) {
        if (a.size > 1e6) {
          ...
          n.find('input[type="file"]')
            .closest(".wrapper-input")
            .addClass("erro")
            .removeClass("with-file");
  ...
  t.on("blur", function () {
    ...
    if (e.val() === 0 || e.val() == "") {
      TweenMax.staggerTo(n.find("label"), 0.5, {
        opacity: 1,
        ease: Expo.easeOut,
      });
    }
  ...
  n.on("submit", function (e) {
    ...
    if (!n.hasClass("sending")) {
      ...
      TweenMax.staggerTo(
        n.find(".elastic-btn .text .char"),
        0.5,
        { y: "-50px", ease: Expo.easeOut },
        0.05
      );
      TweenMax.to(n.find(".loader-wrapper"), 0.2, { opacity: 1, delay: 1 });
      if ($(".page-toload").hasClass("single-queremos-page")) {
        ...
        a.append(
          "_wp_http_referer",
          n.find("input[name='_wp_http_referer']").val()
        );
        a.append(
          "affinity_nonce",
          n.find("input[name='affinity_nonce']").val()
        );
        ...
        submitFormData(
          a,
          function (e) {
            TweenMax.to(n.find(".elastic-btn"), 0.5, { opacity: 0 });
            TweenMax.fromTo(
              n.find(".sent-message .success-msg"),
              1,
              { autoAlpha: 0, y: 40 },
      ...
      if ($(".page-toload").hasClass("estamos-page")) {
        if ($(".contact-form").attr("data-type") == "know-about-affinity") {
          ...
          a.append(
            "contacto_city",
            n
              .find(".options-main-wrapper .option-wrapper.done")
              .attr("data-city")
          );
          if (i) {
            a.append("file", i);
        ...
        submitFormData(
          ...
          function (e) {
            $.doTimeout(2e3, function () {
              ...
              TweenMax.set(n.find(".elastic-btn .text .char"), { y: "-50px" });
            });
            $.doTimeout(4e3, function () {
              TweenMax.staggerTo(
                n.find(".elastic-btn .text .char"),
                1,
                { y: "0px", opacity: 1, ease: Expo.easeOut },
                -0.05,
                function () {
                  $("form.contact-form")[0].reset();
                  $("form.contact-form input").removeClass("erro");
                  $("form.contact-form .wrapper-input").removeClass(
                    "is-focused"
                  );
                  $("form button.elastic-btn").removeClass("active");
                  $("form .rgpd-wrapper svg").removeClass("active");
                  $("form.contact-form input.check-policy").val("");
                  $("form.contact-form input.check-policy").trigger("blur");
                  $(".file-container span").html(
                    "Max. file size 5mb. Allowed format: PDF"
                  );
                  $(".wrapper-input").removeClass("erro");
                  n.css("pointer-events", "all");
                  $(".form-container .form-options").css(
                    "pointer-events",
                    "none"
                  );
                  TweenMax.to(
                    $(".options-main-wrapper  .option-wrapper.done").find(
                      ".full"
                    ),
                    1,
                    { opacity: 0, ease: Elastic.easeOut.config(1, 0.7) }
                  );
                  TweenMax.to(
                    $(".options-main-wrapper  .option-wrapper.done").find(
                      ".dash"
                    ...
                    1,
                    {
                      ...
                      onComplete: function () {
                        n.find(
                          ".options-main-wrapper .option-wrapper.done"
                        ).removeClass("done");
                      },
                    }
                  );
              ...
              TweenMax.to(n.find(".loader-wrapper"), 0.2, { opacity: 0 });
            });
...
function animateRollingLetters() {
  var e = $(".rolling-letters"),
    ...
    i = false;
  var n = function () {
    TweenMax.set(e.find(".js-letter-anime"), { opacity: 0 });
  ...
  var r = function () {
    i = true;
    t.addClass("animate");
    TweenMax.staggerTo(e.find(".js-letter-anime"), 1, { opacity: 1 }, 0.5);
  };
  var l = function () {
    i = false;
  ...
  function f() {
    o = _rAF_loop(f);
    if (i) {
      TweenMax.to(e, 0.2, { x: "-=10px" });
      if (!verge.inViewport(e)) {
        TweenMax.set(e, { x: _globalViewportW });
      }
    }
  }
  return { init: n, animate: r, pause: l, kill: c };
}
function animateMorphLetters() {
  var e = $(".morphing-letter");
  e.each(function () {
    var e = $(this),
      t = new TimelineMax({ paused: true });
...
function breakTitleLetters(e) {
  ...
  for (var o = 0; o < t.length; o++) {
    ...
    for (var n = 0; n < i.length; n++) {
      ...
      r.css({ color: "inherit", "font-family": "inherit" });
      e.append(r);
    }
    e.append("<br>");
  }
...
//     return { init: e };
//   } else {
//     console.log("Элементы с классом 'js-hashtag-scroll' не найдены.");
//     return null;
//   }
// }
function initViewportAnimations() {
  var t = $(".js-title-element"),
    ...
    s = $(
      ".image-blocks .answer-wrapper-text, .recruitment .answer-wrapper-text"
    ),
    r = null,
    l = null;
  var c = function () {
    var e = { rootMargin: "0px", threshold: [0, 0.75] };
    l = function (e, a) {
      e.forEach(function (e) {
        if (e.isIntersecting || e.intersectionRatio > 0) {
          ...
          switch (e.target.type) {
            case "titleElement":
              var t = $(e.target);
              TweenMax.to(t, 1, { y: "0px", ease: Power4.easeOut });
              break;
            case "textElement":
              var t = $(e.target);
              TweenMax.to(t, 1, { x: "0px", opacity: 1, ease: Power4.easeOut });
              break;
            case "bigTextElement":
              var t = $(e.target);
              TweenMax.to(t, 1, { y: "0px", opacity: 1, ease: Power4.easeOut });
              break;
            case "imageBlocksQuestionElement":
              ...
              TweenMax.staggerTo(t, 1, { scaleX: 1, ease: Power4.easeOut });
              if (t.closest(".question-row").find(".image-wrapper")) {
                TweenMax.to(
                  t.closest(".question-row").find(".image-wrapper"),
                  2,
                  {
                    opacity: 1,
                    scale: 1,
            ...
            case "imageBlocksAnswerElement":
              var t = $(e.target);
              TweenMax.to([t.find("h3")], 0.5, {
                y: "0px",
                opacity: 1,
                delay: 0.8,
              });
              TweenMax.to([t.find("h4")], 0.5, {
                y: "0px",
                opacity: 0.6,
                delay: 1.5,
              });
              TweenMax.staggerTo(t, 1, { scaleX: 1, ease: Expo.easeOut });
              break;
    ...
    t.each(function (e) {
      ...
      TweenMax.set(t[0], { y: t.height() });
      r.observe(t[0]);
    });
    o.each(function (e) {
      var t = $(this);
      t[0].type = "textElement";
      TweenMax.set(t[0], { x: "-40px", opacity: 0 });
      r.observe(t[0]);
    });
    i.each(function () {
      var e = $(this);
      e[0].type = "writeTextElement";
      TweenMax.set(e.find(".char"), { opacity: 0 });
      r.observe(e[0]);
    });
    a.each(function (e) {
      var t = $(this);
      t[0].type = "bigTextElement";
      TweenMax.set(t[0], { y: "100px", opacity: 0 });
      r.observe(t[0]);
    });
    n.each(function () {
      var e = $(this);
      e[0].type = "imageBlocksQuestionElement";
      TweenMax.set([e.find("h2"), e.find("h3")], { y: "40px", opacity: 0 });
      TweenMax.set(e, { scaleX: 0.01 });
      r.observe(e[0]);
    });
    s.each(function () {
      var e = $(this);
      e[0].type = "imageBlocksAnswerElement";
      TweenMax.set([e.find("h3"), e.find("h4")], { y: "40px", opacity: 0 });
      TweenMax.set(e, { scaleX: 0.01 });
      r.observe(e[0]);
    });
  };
...
function initScrollAnimations() {
  ...
  var o = function () {
    for (var e = 0, t = s.length; e < t; e++) {
      if (checkInView(s[e], 0.5)) {
        var a = s[e].element,
          o = s[e].offsetY - _scrollY + _globalViewportH * 0.5,
          i = (_globalViewportH - o) / _globalViewportH;
        a.find(".word").each(function (e) {
          var t = $(this);
          TweenMax.to(t, 0.25, { y: i * 100 * e });
        });
      }
    }
    for (var e = 0, t = r.length; e < t; e++) {
      if (checkInView(r[e], 0)) {
        var a = r[e].element,
          o = r[e].offsetY - _scrollY + _globalViewportH * 0.5,
          i = (_globalViewportH - o) / _globalViewportH,
          n = r[e].friction;
        if (!$_html.hasClass("ie") || !$_html.hasClass("edge")) {
          TweenMax.to(a, 0.25, { y: -i * 100 * n });
        }
      }
    }
  };
  var i = function () {};
  return { init: a, update: o, kill: i };
}
function displacementImage(t) {
  PIXI.utils.skipHello();
  var a = window.devicePixelRatio;
  a = 1;
  var o = new PIXI.autoDetectRenderer(
    _globalViewportW * 1.1 * a,
    _globalViewportH * 1.3 * a,
    { transparent: true, antialias: true, forceCanvas: true }
  );
  ...
  var c = function () {
    var e = cover(
      3400,
      2328,
      _globalViewportW * 1.1,
      _globalViewportH * 1.1,
      false
    );
    ...
    i.addChild(s);
    TweenMax.to($(".page-header canvas"), 1, { opacity: 1, delay: 1 });
    l.autoStart = true;
    n.interactive = true;
...
function headerParallax(e) {
  ...
  init = function () {
    ...
    t.on("mousemove.headerParallax", function (e) {
      ...
      TweenMax.to(i, 1, { x: a * 0.01, y: o * 0.01 });
    });
  };
  kill = function () {};
    ...
    t.each(function () {
      ...
      e.on("mousemove.loveAttraction", function (e) {
        ...
        if (t.parent().hasClass("js-open")) {
          TweenMax.to(t.parent(), 0.8, {
            y: "0px",
            x: "0px",
            ease: Elastic.easeOut.config(1, 0.75),
          });
          if (t.hasClass("brand-item")) {
            TweenMax.to(t.find(".brand-logo"), 0.5, { y: "0px", x: "0px" });
          }
        } else {
          TweenMax.to(t.parent(), 0.5, { x: a * i, y: o * i });
          if (t.hasClass("brand-item")) {
            TweenMax.to(t.find(".brand-logo"), 0.5, {
              x: a * i * 0.5,
              y: o * i * 0.5,
            });
          }
      ...
      e.on("mouseleave.loveAttraction", function () {
        var e = $(this);
        TweenMax.to(e.parent(), 0.8, {
          y: "0px",
          x: "0px",
          ease: Elastic.easeOut.config(1, 0.75),
        });
        if (e.hasClass("brand-item")) {
          TweenMax.to(e.find(".brand-logo"), 0.5, { y: "0px", x: "0px" });
        }
      });
    });
  };
...
function textFireworks(i, e) {
  ...
  switch (s) {
    case "jellyType":
      var l = new TimelineMax({ paused: true }),
        t = new SplitText(n, { type: "words,chars" }),
        c = t.chars;
      break;
    case "smoothEntrance":
      var l = new TimelineMax({ paused: true }),
  ...
  var a = function (e) {
    switch (s) {
      case "jellyType":
        TweenMax.set(n, { opacity: 1 });
        TweenMax.set(n, { perspective: 1e3 });
        l.staggerFrom(
          c,
          0.8,
          {
        ...
        if (verge.inViewport(n) && !n.hasClass("js-animated")) {
          $_pageHeader.find("h1").addClass("js-animated");
          l.play();
        }
        break;
      case "smoothEntrance":
        ...
        if (n.closest(".header-text").length > 0) var o = 0.8;
        else var o = 1;
        TweenMax.set(n, { opacity: o });
        l.staggerFrom(
          c,
          0.8,
          { opacity: 0, y: t, ease: Back.easeOut.config(1) },
          0.015,
          "+=" + r,
          function () {
            if (
              $_body.hasClass("somos") ||
              $_body.hasClass("estamos") ||
              $_body.hasClass("queremos") ||
              $_body.hasClass("home")
            ) {
              if (typeof e == "function") e();
            }
  ...
  return { init: a, animate: o, kill: f };
}
function sequenceDance(e) {
  var t = e,
    ...
    o = t.find(".columns");
  var i = function () {
    TweenMax.set(a, { scaleX: 0, transformOrigin: "left center" });
    TweenMax.set(o.find("svg"), { scale: 0 });
    TweenMax.set([o.find("h3"), o.find("p")], { y: "40px", opacity: 0 });
  };
  var n = function () {
    TweenMax.to(a, 3, { scaleX: 1, ease: Power4.easeOut });
    $.doTimeout(333, function () {
      TweenMax.staggerTo(
        o.find("svg"),
        2,
        { scale: 1, ease: Elastic.easeOut.config(1, 0.7) },
        0.33
      );
      TweenMax.staggerTo(
        o.find("h3"),
        2,
        { y: "0px", opacity: 1, ease: Elastic.easeOut.config(1, 0.5) },
        0.33
      );
      TweenMax.staggerTo(
        o.find("p"),
  ...
  var s = function () {};
  return { init: i, animate: n, kill: s };
}
function letterMorphParallax(e) {
  ...
  var a = function () {
    t.data(
      "normal",
      "M23.145,369.802  c19.022,255.764,173.271,293.386,379.272,293.386c206.003,0,302.946-143.638,302.946-320.822 c0-177.187-96.944-320.518-302.946-320.823C179.634,21.21,2.745,95.514,23.145,369.802z"
    );
    t.data("active", t.find("path").attr("d"));
    t.find("path").attr("d", t.data("normal"));
    TweenMax.set(t, { opacity: 0, scale: 0 });
    ...
    t.on("mousemove.letterMorphParallax", function (e) {
      ...
      var a = e.clientX - t[0].getBoundingClientRect().left - t.width() / 2;
      var o = e.clientY - t[0].getBoundingClientRect().top - t.height() / 2;
      TweenMax.to(t.parent(), 0.5, { x: a * 0.1, y: o * 0.1 });
    });
  ...
  return { init: a, animateIn: o, kill: i };
}
function initMouseAnimations() {
  var e = function () {
    $_pageHeader.on("mousemove", function (e) {
      ...
      TweenMax.to(t.find(".letter-wrapper"), 0.5, { x: a * 0.01, y: o * 0.01 });
      TweenMax.to(t.find(".title h2"), 0.75, { x: a * 0.05, y: o * 0.05 });
      TweenMax.to(t.find(".image-wrapper"), 0.75, { x: a * 0.02, y: o * 0.02 });
    });
    $_pageHeader.on("mouseleave", function () {
      var e = $(this);
      TweenMax.to(e.find(".letter-wrapper"), 0.5, {
        x: 0,
        y: 0,
        ease: Expo.easeOut,
      });
      TweenMax.to(e.find(".title h2"), 0.75, {
        x: 0,
        y: 0,
        ease: Expo.easeOut,
      });
      TweenMax.to(e.find(".image-wrapper"), 0.75, {
        x: 0,
        y: 0,
        ease: Expo.easeOut,
      });
...
function loadingAnimation() {
  ...
  var a = function () {
    t.css("display", "block");
    TweenMax.set(t, { x: _mouseX, y: _mouseY });
    TweenMax.to(t, 1, { scale: 1, ease: Elastic.easeOut.config(1, 0.5) });
  ...
  var o = function () {
    TweenMax.to(t, 1, {
      ...
      onComplete: function () {
        t.css("display", "none");
        TweenMax.set(t, { clearProps: "all" });
        TweenMax.killTweensOf(t.find("svg path"));
        TweenMax.set(t.find("svg path"), { clearProps: "all" });
        t.find("svg").remove();
        t.append(e.clone());
...
function checkInView(e, t, a) {
  if ((t = undefined)) t = 0;
  if (
    e.offsetY >= _scrollY + _globalViewportH ||
    e.offsetY + e.height <= _scrollY
  )
    return false;
  else return true;
}
      ...
      if (settings.centerBrowser) {
        ...
        window
          .open(
            settings.windowURL,
            settings.windowName,
            e + ",left=" + settings.left + ",top=" + settings.top
          )
          .focus();
      }
      return false;
...
function callPlayer(a, e, t) {
  ...
  if (n && !o) {
    ...
    !n ||
    (o && (!o.contentWindow || (i && !i.ready))) ||
    ((!i || !i.ready) && typeof e === "function")
  ) {
    ...
    o.contentWindow.postMessage(
      JSON.stringify({ event: "command", func: e, args: t || [], id: a }),
      "*"
    );
  }
  function s(e, t) {
    ...
    a
      ? a("message", t, !1)
      : (e ? window.attachEvent : window.detachEvent)("onmessage", t);
  }
}
...
function lockBodySafari() {
  ...
  if (window.pageYOffset) {
    ...
    t.css({ top: -_scrollTopMobileSafariFix });
  }
  e.css({ height: "100%", overflow: "hidden" });
}
function unlockBodySafari() {
  var e = $("html, body"),
    t = $(".scroll-content-wrapper");
  e.css({ height: "", overflow: "" });
  t.css({ top: "" });
...
function buroParallaxScroll() {
  ...
  var a = function (e) {
    for (var t = 0, a = i.length; t < a; t++) {
      if (
        e + _globalViewportH > i[t].offsetY &&
        e + _globalViewportH < i[t].offsetY + i[t].height + _globalViewportH
      ) {
        if ($_body.hasClass("wine-advice")) {
          TweenMax.to(i[t].element, 1, {
            y: -e * i[t].friction * 0.5,
            ease: Power4.easeOut,
          });
        } else {
  ...
  var o = function () {
    i.forEach(function (e, t) {
      ...
      e.offsetY =
        ...
        _buroScroll.getStatus().scrollVal;
    });
  };
  var n = function () {
    window.removeEventListener("resize", o);
  };
  return { init: t, update: a, kill: n };
}
...
function loadPages(s, e, t) {
  ...
  var o = $(".main-transition"),
    i =
      Math.floor(
        Math.random() *
          $(".bg-transition-new svg").not(".main-transition").length -
          1
      ) + 1;
  ($randomSvg = $(".bg-transition-new svg:not(.main-transition)").eq(i)),
    (new_body_class = t),
    (d = $randomSvg.find("path").attr("d")),
    (data_morph = $randomSvg.find("path").attr("data-morph")),
    (data_final_morph = $randomSvg.find("path").attr("data-final-morph"));
  ...
  if (
    verge.inViewport($_pageFooter) &&
    (new_body_class == "fazemos" ||
      new_body_class == "queremos" ||
      new_body_class == "noticias" ||
      new_body_class == "home" ||
      new_body_class == "single-service")
  )
    $(".bg-transition-new").addClass("alternative-color");
  ...
  TweenMax.fromTo(
    ...
    1,
    { y: "100px", opacity: 0 },
    { y: "0px", opacity: 1, delay: 0.5, ease: Power4.easeOut }
  );
  r.load(s + " .page-toload", function (e, t, a) {
    ...
    $.doTimeout(n, function () {
      ...
      $_headerMain
        .find(".desktop-language .other-languages")
        .html($(e).find(".desktop-language .other-languages li"));
      $_headerMain
        .find("#nav-main-mobile .other-languages")
        .html($(e).find("#nav-main-mobile .other-languages li"));
      $(".page-next .preload").imagesLoaded(function (e, t, a) {
        var o = $(this).imagesLoaded();
        o.always(function () {
          if (
            r.find(".page-toload").attr("data-bodyClass").split(" ")[0] ==
            "single-service"
          )
            var e = 1;
          else var e = 0.5 + 1;
          $.doTimeout(1e3 + e * 1e3, function () {
            ...
            $(".bg-transition-new")
              .removeClass(new_body_class)
              .removeClass("alternative-color")
              .removeClass("somos")
              .removeClass("estamos")
              .removeClass("queremos")
              .removeClass("single-queremos")
              .removeClass("single-service")
              .removeClass("home")
              .removeClass("noticias")
              .removeClass("single-noticias");
          });
          TweenMax.to($(".bg-transition-new .main-transition path"), c, {
            morphSVG: $(".bg-transition-new .main-transition path").attr(
              "data-final-morph"
            ),
            ease: Expo.easeOut,
            delay: e,
          ...
          $_headerMain.css({ top: "0px" });
          TweenMax.set($_headerMain, { y: "0px" });
          $_headerMain.removeClass("js-drop");
          manageBodyClasses();
  ...
  if (e) {
    ...
    $_toPreload.imagesLoaded(function (e, t, a) {
      ...
      o.always(function () {
        ...
        randomSentenceTransition();
        if ($_pageToLoad && $_pageToLoad.attr("data-bodyClass")) {
...
function onStartPage() {
  ...
  if (l != "") {
    ...
    $.doTimeout(1e3, function () {
      ...
      else goTo(c, 1500, [0.7, 0, 0.3, 1], 0);
    });
  }
  if ($_html.hasClass("no-object-fit")) {
...
function startModal() {
  ...
  function l(a, e, t) {
    ...
    $("#modal-wrapper").css({ top: _customScroll.offset.y + "px" });
    _customScrollModal.addListener(function (e) {
      $(".btn-close-modal").css({ top: e.offset.y + "px" });
    });
    TweenMax.set(n, { scale: 0.7, opacity: 0 });
    ...
    n.load(a + " .toload", function () {
      ...
      t.always(function (e) {
        ...
        TweenMax.to(o, 0.8, { opacity: 0.8, ease: Expo.easeOut });
      });
...
function mainNavigation() {
  ...
  $_headerMain.find("#nav-main li a").on("click", function () {
    var e = $(this);
    if (
      e.closest("li").hasClass("active") &&
      !$_body.hasClass("single-service") &&
      !$_body.hasClass("single-queremos")
    )
      return false;
  });
  ...
  if (!$_body.hasClass("mobile")) {
    $(document)
      .on("mouseenter", ".language-wrapper", function () {
        ...
        TweenMax.set(e, { overflow: "visible" });
        TweenMax.to(n, 0.5, { autoAlpha: 1 });
      })
...
$(document).ready(function () {
  ...
  $(document).on("click", 'a[data-remote="true"]', function () {
    ...
    if ($_body.hasClass("mobile")) {
      $_body.prepend(
        "<span class='loading-mobile'><span class='loading-bg'></span></span>"
      );
      TweenMax.to($(".loading-mobile .loading-bg"), 2, {
        x: "-30%",
        ease: Expo.easeInOut,
  ...
  $_window.on(
    ...
    $.debounce(500, function () {
      ...
      if ($("body").hasClass("fazemos") && !$("body").hasClass("mobile"))
        location.reload();
      if ($_html.hasClass("no-object-fit")) {
        var e = $(".page-current .element-cover");
        resizeLikeCover(e);
...
function estamosPage(e) {
  ...
  var o = animateRollingLetters(),
    ...
    s = textFireworks({
      ...
      animationType: "smoothEntrance",
      delay: 0,
      setupArgs: { yValue: 100, animationTime: 0.4 },
    }),
    r = textFireworks({
      element: $(".page-footer h3"),
      animationType: "smoothEntrance",
      delay: 0.3,
      setupArgs: { yValue: 40, animationTime: 0.8 },
    }),
  ...
  var g = function () {
    ...
    if (!_browserObj.isMobile) {
      ...
      TweenMax.to($_body.find(".main-logo"), 0.5, { opacity: 1 });
      TweenMax.to($_body.find(".language-wrapper"), 0.5, { opacity: 1 });
      TweenMax.staggerTo(
        $_pageHeader.find("h2 .char"),
        1.8,
        { y: "0px", opacity: 1, ease: Power2.easeInOut, delay: 0.5 },
        0.05,
        function () {
          TweenMax.staggerTo(
            $_pageHeader.find("h2 .char"),
            3,
            { y: "5px", yoyo: true, repeat: -1, ease: Sine.easeInOut },
            0.25
          );
        }
      );
      hoverLinksMenu();
      TweenMax.set(h, { opacity: 0 });
    } else {
      if (_clickAnchorContacts) {
        _clickAnchorContacts = false;
        setTimeout(function () {
  ...
  function _() {
    ...
    e.on("mousemove", function (e) {
      ...
      var a =
        e.clientX - t.parent()[0].getBoundingClientRect().left - t.width() / 2;
      var o =
        e.clientY - t.parent()[0].getBoundingClientRect().top - t.height() / 2;
      TweenMax.to(t, 0.5, { x: a * 0.1, y: o * 0.1 });
    });
  ...
  function y() {
    ...
    var l = new google.maps.Marker({ position: t });
    google.maps.event.addListenerOnce(map, "tilesloaded", function () {
      ...
      TweenMax.fromTo(
        ...
        1,
        { y: "40px", autoAlpha: 0 },
        { y: "0px", autoAlpha: 1, ease: Expo.easeOut }
      );
    });
    ...
    if ($_body.hasClass("tablet") && $_html.hasClass("orientation_landscape"))
      map.panBy(-280, 0);
    if ($_body.hasClass("tablet") && $_html.hasClass("orientation_portrait"))
      map.panBy(40, -200);
    if (!$_body.hasClass("phone") && !$_body.hasClass("tablet"))
      map.panBy(-300, 0);
    ...
    c.on("click", function () {
      ...
      TweenMax.fromTo(
        d.find("h2").filter("." + t + "-hash"),
        1,
        { y: d.height(), opacity: 0.25 },
        {
          y: 0,
          opacity: 0.25,
          ease: Expo.easeInOut,
      ...
      TweenMax.to(f.filter(".active"), 0.5, {
        y: "40px",
        autoAlpha: 0,
        onComplete: function () {
          TweenMax.fromTo(
    ...
    if ($_body.hasClass("mobile") && $_html.hasClass("orientation_portrait"))
      h.scrollLeft(_globalViewportW / 3);
    function u(e, t) {
      var a = $(".map-marker");
      var o, i;
      var n = e.getPosition();
  ...
  function T(e) {
    ...
    if (!_browserObj.isPhone) {
      if (
        verge.inViewport($_pageFooter, -_globalViewportH / 3) &&
        !$_pageFooter.hasClass("js-animated-2")
      ) {
      ...
      if (
        verge.inViewport(h, -150) &&
        !h.hasClass("js-animated") &&
        !$_body.hasClass("mobile")
      ) {
        ...
        TweenMax.staggerFrom(
          ".fake-point",
          0.1,
          { opacity: 0, delay: 0.2, ease: Elastic.easeOut.config(1, 0.5) },
          0.1,
          function () {
  ...
  function p() {
    ...
    a.on("mouseenter", function () {
      ...
      TweenMax.staggerFromTo(
        ...
        1,
        { y: 50, opacity: 1 },
        { y: 0, opacity: 1, ease: Elastic.easeOut.config(1, 0.7) },
        0.05
      );
      TweenMax.fromTo(o, 1, { y: 20, opacity: 0 }, { y: 0, opacity: 1 });
    ...
    a.on("mouseleave", function () {
      ...
      TweenMax.set([a.find(".char"), o], { opacity: 0 });
      if (e.hasClass("nearshoring-item")) {
        l.can_animate = false;
        l.go_to_end = true;
      }
    ...
    t.add(
      "nearshoring_0",
      "/imgs/nearshoring/menu/menu-nearshoring@2x_0.png"
    );
    t.add(
      "outsourcing_0",
      "/imgs/outsourcing/menu/menu-outsourcing@2x_0.png"
    );
    t.add("software_0", "/imgs/software/menu/menu-software@2x_0.png");
    t.load(function () {
      var e = [],
        t = [],
        a = [];
      ...
      $_pageHeader
        .find(".nearshoring-item")
        .css("height", $_pageHeader.find(".nearshoring-item").width());
      x.x =
        $_pageHeader.find(".nearshoring-item")[0].getBoundingClientRect().left *
          2 +
        $_pageHeader.find(".nearshoring-item").outerWidth();
      x.y =
        $_pageHeader.find(".nearshoring-item")[0].getBoundingClientRect().top *
          2 +
        $_pageHeader.find(".nearshoring-item").outerHeight();
      x.anchor.set(0.5);
      x.width = 1200;
      x.height = 1200;
      TweenMax.set(x.scale, { x: 0.98, y: 0.98 });
      TweenMax.set(x, { alpha: 0 });
      m.stage.addChild(x);
      TweenMax.to(x.scale, 0.5, { x: 1.8, y: 1.8, ease: Expo.easeOut });
      TweenMax.to(x, 0.5, { alpha: 1 });
      outsourcingFirstSprite = new PIXI.extras.AnimatedSprite(t);
      $_pageHeader
        .find(".outsourcing-item")
        .css("height", $_pageHeader.find(".outsourcing-item").width());
      outsourcingFirstSprite.x =
        $_pageHeader.find(".outsourcing-item")[0].getBoundingClientRect().left *
          2 +
        $_pageHeader.find(".outsourcing-item").outerWidth();
      outsourcingFirstSprite.y =
        $_pageHeader.find(".outsourcing-item")[0].getBoundingClientRect().top *
          2 +
        $_pageHeader.find(".outsourcing-item").outerHeight();
      outsourcingFirstSprite.anchor.set(0.5);
      outsourcingFirstSprite.width = 1200;
      outsourcingFirstSprite.height = 1200;
      TweenMax.set(outsourcingFirstSprite.scale, { x: 0.98, y: 0.98 });
      TweenMax.set(outsourcingFirstSprite, { alpha: 0 });
      m.stage.addChild(outsourcingFirstSprite);
      TweenMax.to(outsourcingFirstSprite.scale, 0.5, {
        x: 1.8,
        y: 1.8,
        ease: Expo.easeOut,
      });
      TweenMax.to(outsourcingFirstSprite, 0.5, { alpha: 1 });
      _ = new PIXI.extras.AnimatedSprite(a);
      $_pageHeader
        .find(".software-item")
        .css("height", $_pageHeader.find(".software-item").width());
      _.x =
        $_pageHeader.find(".software-item")[0].getBoundingClientRect().left *
          2 +
        $_pageHeader.find(".software-item").outerWidth();
      _.y =
        $_pageHeader.find(".software-item")[0].getBoundingClientRect().top * 2 +
        $_pageHeader.find(".software-item").outerHeight();
      _.anchor.set(0.5);
      _.width = 1200;
      _.height = 1200;
      TweenMax.set(_.scale, { x: 0.98, y: 0.98 });
      TweenMax.set(_, { alpha: 0 });
      m.stage.addChild(_);
      TweenMax.to(_.scale, 0.5, { x: 1.8, y: 1.8, ease: Expo.easeOut });
      TweenMax.to(_, 0.5, { alpha: 1 });
      m.start();
      var n = new PIXI.loaders.Loader();
      for (i = 0; i < l.total_frames; i++) {
        n.add(
          "nearshoring_" + i,
          "/imgs/nearshoring/menu/menu-nearshoring@2x_" + i + ".png"
        );
      }
      for (i = 0; i < c.total_frames; i++) {
        n.add(
          "outsourcing_" + i,
          "/imgs/outsourcing/menu/menu-outsourcing@2x_" + i + ".png"
        );
      }
      for (i = 0; i < f.total_frames; i++) {
        n.add(
          "software_" + i,
          "/imgs/software/menu/menu-software@2x_" + i + ".png"
        );
      }
      n.load(function () {
        h();
    ...
    function h() {
      ...
      v.anchor.set(0.5);
      v.type = "nearshoring";
      TweenMax.set(v.scale, { x: 1.8, y: 1.8 });
      TweenMax.set(v, { alpha: 1 });
      m.stage.addChild(v);
      ...
      g.anchor.set(0.5);
      g.type = "outsourcing";
      TweenMax.set(g.scale, { x: 1.8, y: 1.8 });
      TweenMax.set(g, { alpha: 1 });
      m.stage.addChild(g);
      ...
      w.anchor.set(0.5);
      w.type = "software";
      TweenMax.set(w.scale, { x: 1.8, y: 1.8 });
      TweenMax.set(w, { alpha: 1 });
      m.stage.addChild(w);
      b = _rAF_loop(a);
      a();
  ...
  function u() {
    c.on("mousemove", function (e) {
      ...
      var o =
        e.clientY - t.parent()[0].getBoundingClientRect().top - t.height() / 2;
      TweenMax.to(t, 0.5, { x: a * 0.1, y: o * 0.1 });
      TweenMax.to(t.find("h3"), 0.75, { x: a * 0.05, y: o * 0.05 });
    });
  ...
  var s = function () {
    if (!$_body.hasClass("mobile")) {
      o = new Pizzicato.Sound(
        {
          source: "file",
          loop: true,
          options: { path: "public/audio/404_owl.mp3" },
        },
        function () {
          o.play();
        }
      ...
      e.on("mousemove.headerParallax", function (e) {
        ...
        var a = e.clientX - t[0].getBoundingClientRect().left - t.width() / 2;
        var o = e.clientY - t[0].getBoundingClientRect().top - t.height() / 2;
        TweenMax.to(n, 1, { x: a * 0.01, y: o * 0.01 });
        TweenMax.to(i.eq(0), 1, { x: a * 0.025, y: o * 0.025 });
        TweenMax.to(i.eq(1), 1, { x: a * 0.035, y: o * 0.035 });
        TweenMax.to(i.eq(2), 1, { x: a * 0.025, y: o * 0.025 });
      });
    }
  };
  var r = function () {
  ...
  function l() {
    ...
    function m() {
      ...
      function t() {
        ...
        e.opacity = 1;
        e.speedOpacity = Math.random() * 0.3;
      }
    }
    function g() {
...
function homePage() {
  ...
  var 
    ...
    c = new GlAnimation({
      ...
      desktopMaxWidth: 1440,
      objsGroup_ScaleDesktop: 1,
      objLetter_ScaleDesktop: 0.95,
      objGroupX_desktop: 0,
      objGroupY_desktop: 0.5,
      objGroupZ_desktop: 0,
      desktopMaxMaxWidth: 1800,
      objsGroup_ScaleMaxDesktop: 1,
      objLetter_ScaleMaxDesktop: 0.95,
      objGroupX_MaxDesktop: 0,
      objGroupY_MaxDesktop: 0.5,
      objGroupZ_MaxDesktop: 0,
      objWidthBigDesktop: 1,
      objLetter_ScaleBigDesktop: 0.95,
    ...
    f = new GlAnimation({
      ...
      objsGroup_ScaleTabletLand: 0.00108,
  ...
  var y = function () {
    ...
    TweenMax.to(_, 2, {
      attr: {
        d: "M396,1S42.25-.17,6,254c-34,260,389,75.06,389,431Z"
      },
      repeat: -1,
      yoyo: true,
      ease: Sine.easeOut,
    ...
    if (!$_body.hasClass("mobile")) {
      ...
      TweenMax.set(h.find(".news-wrapper"), { y: "200px", force3D: true });
      n.init();
      s.init();
      r.init();
      if (!$_html.hasClass("safari")) {
  ...
  w.on("submit", function (e) {
    ...
    $.ajax({
      ...
      success: function (e) {
        console.log("success");
        TweenMax.to(w.find(".success-text"), 0.7, {
          autoAlpha: 1,
          ease: Elastic.easeOut.config(1, 0.7),
        });
        TweenMax.to(w.find(".morph-container path"), 0.7, {
          stroke: "#2ecc71",
          ease: Elastic.easeOut.config(1, 0.7),
        });
        t.removeClass("sending");
  ...
  function M() {
    ...
    g.on("click", function () {
      ...
      TweenMax.to(n.parent().find("span"), 0.4, {
        opacity: 0,
        ease: Expo.easeOut,
      });
      TweenMax.to(n, 1, {
      ...
      $.get(
        "/wp-json/affinity/v1/news/more-news?offset=" + s + "&limit=" + r,
        function (e) {
          var i = $(e["news"]);
          i.imagesLoaded(function (e, t, a) {
            var o = $(this).imagesLoaded();
            o.always(function () {
              TweenMax.set(i, { opacity: 0, y: "50px" });
    ...
    if (!_browserObj.isPhone) {
      ...
      e.on("click", function () {
        ...
        if ($_body.hasClass("pt-lang")) {
          $(".full-video")
            .find("video source")
            .attr("src", "/video/" + e + "-full-pt.mp4");
        } else {
          $(".full-video")
            .find("video source")
            .attr("src", "/video/" + e + "-full.mp4");
        }
        TweenMax.to(".full-video", 1, { opacity: 1, ease: "Expo.easeInOut" });
      ...
      window.onorientationchange = function () {
        if (screen.orientation.angle > 0) {
          $(".home-fullvideos-container .full-video .element-cover").css(
            "object-fit",
            "cover"
          );
        } else {
  ...
  function C() {
    ...
    var p = function () {
      ...
      for (i = 0; i < 30; i++) {
        e.add(
          "envelope_" + i,
          "/imgs/home/envelope/envelope_" + i + ".png"
        );
      }
      e.load(function () {
        g();
    ...
    return { init: p, animate: u, kill: h };
    function m() {
  ...
  function j() {
    var e = $("#social-activity"),
      n = e.find(
        ".twitter-container, .news-container, .vertical-block, .gallery:not(.gallery-facebook-titles), .insta-container"
      ),
    ...
    function a() {
      t.each(function () {
        var e = $(this);
        TweenMax.set(e.find("li"), { clearProps: "all" });
    ...
    function o() {
      var e = $(".clients"),
        t = $(".contacts");
      var a = { rootMargin: "0px", threshold: [0] };
      var o = function (e, t) {
        e.forEach(function (e) {
          if (e.isIntersecting || e.intersectionRatio > 0) {
    ...
    function s(e, t) {
      ...
      if (e == "next") {
        if (a.hasClass("gallery-facebook")) {
          TweenMax.to(
            a.parent(".facebook-container").find(".gallery-facebook-titles"),
            2,
            {
              x:
                "-=" +
                a
                  .parent(".facebook-container")
                  .find(".gallery-facebook-titles")
                  .outerWidth(),
              delay: i + 0.1,
              ease: Expo.easeOut,
            }
  ...
  function O() {
    ...
    o.find("input").on("focus", function () {
      TweenMax.staggerTo(o.find("label"), 0.5, {
        opacity: 0,
        ease: Expo.easeOut,
      });
    });
    ...
    o.on("submit", function (e) {
      ...
      if (validateForm(o) && !o.hasClass("js-sending")) {
        ...
        t.find(".elastic-btn").css({ "pointer-events": "none" });
        TweenMax.staggerTo(
          o.find(".elastic-btn .text .char"),
          1,
          { y: "-50px", opacity: 0, ease: Expo.easeOut },
          0.05
        );
        TweenMax.to(o.find(".loader-wrapper"), 0.2, { opacity: 1, delay: 1 });
        var a = {
        ...
        $.ajax({
          ...
          data: { action: "sendBrochure", value: a },
          success: function (e) {
            console.log(e);
            $.doTimeout(2e3, function () {
            ...
            $.doTimeout(4e3, function () {
              ...
              TweenMax.to(o.find(".loader-wrapper"), 0.2, { opacity: 0 });
            });
          },
          error: function (e) {
            $.doTimeout(2e3, function () {
  ...
  function P(e) {
    if (!_browserObj.isMobile) {
      ...
      if (
        _scrollY > _globalViewportH / 10 &&
        !$_pageHeader.hasClass("js-paused")
      ) {
        $_pageHeader.addClass("js-paused");
      }
      if (
      ...
      if (verge.inViewport(x, -500) && !x.hasClass("js-animated")) {
        ...
        TweenMax.staggerTo(
          x.find(".job-wrapper"),
          0.8,
          { x: 0, ease: Elastic.easeOut.config(1, 2), force3D: true },
          0.2
        );
      }
      if (verge.inViewport(h, -500) && !h.hasClass("js-animated")) {
        ...
        TweenMax.staggerTo(
          h.find(".news-wrapper"),
          2,
          { y: 0, force3D: true, ease: Elastic.easeOut.config(1, 0.7) },
          0.2
        );
      }
    }
...
function noticiasPage(e) {
  ...
  var j = function () {
    if (!$_body.hasClass("mobile"))
      $_window.on("resize.noticiasPage", $.debounce(500, H));
    nav_bar_width = g.width();
    $_window.on(
      "mousemove.noticiasPage",
      $.debounce(50, function (e) {
        n = e.clientX;
      })
    );
    ...
    if ($_body.hasClass("mobile"))
      $_headerMain
        .find("#nav-main-mobile li[data-controller='noticias-page']")
        .addClass("active");
    if (!$_body.hasClass("mobile")) {
      c = Scrollbar.init(_[0], { speed: 0.8, syncCallbacks: true });
      c.addListener(function (e) {
        if (!$_html.hasClass("edge") && !$_html.hasClass("ie")) {
          TweenMax.set($(".nav-filter"), { top: e.offset.y + "px" });
        }
      });
    }
    ...
    if (o.find(".nav-filter-item-wrapper ul li.active button").text())
      o.find(".nav-filter-active")
        .html(o.find(".nav-filter-item-wrapper ul li.active button").text())
        .addClass("fade-in");
    else o.find(".nav-filter-active").addClass("fade-in");
    var e = M.find("iframe").attr("width") / M.find("iframe").attr("height");
    M.find("iframe")
      .attr("width", M.width())
      .attr("height", M.width() / e);
    TweenMax.to(M, 0.2, { opacity: 1 });
    $(".social-item a").popupWindow({ centerScreen: 1 });
    $(".rotate-title h4").css("height", _globalViewportH);
    $_body.append($(".rotate-title").addClass("rotate-title-fixed"));
    TweenMax.set(".rotate-title-fixed", { x: 100 });
    TweenMax.to(".rotate-title-fixed", 1, { x: 0, ease: Expo.easeOut });
    i.on("clickoutside", function () {
      if (g.hasClass("js-filter-open")) {
        TweenMax.to(i, 0.1, { scaleY: 0, ease: Power4.easeOut });
        TweenMax.to(i.find("li"), 0.1, {
          y: -10,
          autoAlpha: 0,
          ease: Power4.easeOut,
          onComplete: function () {
    ...
    o.find(".nav-filter-active").on("click", function () {
      TweenMax.to(i, 0.75, { scaleY: 1, ease: Elastic.easeOut.config(1, 0.8) });
      TweenMax.staggerFromTo(
        i.find("li"),
        0.75,
        { y: -10, autoAlpha: 0 },
        { y: 0, autoAlpha: 1, delay: 0.15, ease: Elastic.easeOut.config(1, 1) },
        0.05,
        function () {
    ...
    o.find(".nav-filter-btn").on("click", function () {
      ...
      g.removeClass("js-filter-open");
      if (
        o.find(".nav-filter-active").attr("data-active") ==
        e.attr("data-target")
      ) {
        TweenMax.to(i, 0.1, { scaleY: 0, ease: Power4.easeOut });
        TweenMax.to(i.find("li"), 0.1, {
    ...
    e.each(function (e) {
      ...
      if (t.parent(".iframe-embed").hasClass("youtube-iframe")) {
        ...
        t.attr(
          ...
          t
            .attr("src")
            .replace("?feature=oembed", "?feature=oembed&enablejsapi=1")
        );
      } else {
      }
    });
        ...
        var a = new YT.Player(t[0], {
          events: {
            ...
            onStateChange: function (e) {
              if (e.data == 2) {
                callPlayer(
                  $(".iframe-embed.js-playing").attr("id"),
                  "pauseVideo"
                );
                $(".iframe-embed.js-playing")
                  .find("iframe")
    ...
    if (_forPopstate) {
      ...
      if (!$_body.hasClass("mobile")) {
        ...
        var n =
          t.scrollLeft() +
          v.offset().left -
          $(".nav-sidebar").offset().left -
          parseInt(t.css("padding-left"));
        TweenMax.to(t, 1, { scrollTo: { x: n, ease: Power4.easeOut } });
      }
    }
  }
  function P(e) {
    ...
    $.get(t, function (e) {
      ...
      var s =
        $(".iframe-embed").find("iframe").attr("width") /
        $(".iframe-embed").find("iframe").attr("height");
      $(".iframe-embed")
        .find("iframe")
        .attr("width", $(".iframe-embed").width())
        .attr("height", $(".iframe-embed").width() / s);
      TweenMax.to($(".iframe-embed"), 0.2, { opacity: 1 });
      $.doTimeout(1e3, function () {
        _customScroll.unregisterEvents(/scroll/, /wheel/, /touchstart/);
        _customScroll.scrollTo(
          0,
          _customScroll.offset.y + _globalViewportH,
          2e3
        );
        r = true;
        $.doTimeout(2e3, function () {
  ...
  function A(e) {
    ...
    if (!_browserObj.isMobile) {
      for (var o = 0, i = l.length; o < i; o++) {
        if (_scrollDirection == "down") {
          if (
            l[o].offsetY <= e.offset.y &&
            l[o].element.offset().top > 0 &&
            l[o].element.offset().top < _globalViewportH
          ) {
          ...
          if (
            l[o].offsetY <= e.offset.y &&
            l[o].element.offset().top + l[o].height > _globalViewportH &&
            l[o].element.offset().top < _globalViewportH
          ) {
            m.attr("data-activeNew", l[o].element.attr("data-id"));
            S();
    ...
    if (!_browserObj.isMobile && !_browserObj.isEdge && !_browserObj.isIE) {
      if (g.hasClass("js-fix-me")) TweenMax.set(g, { top: e.offset.y + "px" });
      if (t <= 0) {
      ...
      if (e.offset.y >= e.limit.y) {
        if (h) {
          ...
          $_window.on("mousewheel.scrollNextNew", function (e) {
            ...
            TweenMax.set(C.find(".indicator"), { scaleX: u });
            if (u > 1) {
              u = 1;
              h = false;
              r = true;
              ...
              P();
              TweenMax.staggerTo(
                [C.find(".indicator-wrapper"), C.find("p")],
                1,
                { y: "-25px", opacity: 0, ease: Back.easeOut },
                0.05
              );
            }
        ...
        TweenMax.to(C.find(".indicator"), 1, { scaleX: 0, ease: Expo.easeOut });
      }
    }
  }
  return { init: j, kill: E };
}
function queremosPage(e) {
  ...
  var g = [
      { type: "categoria-filters", values: [] },
      { type: "cidades-filters", values: [] },
      { type: "horario-filters", values: [] },
      { type: "nivel-filters", values: [] },
      { type: "contrato-filters", values: [] },
    ],
    d = true,
    o = true,
  ...
  var P = function () {
    ...
    setTimeout(function () {
      $(".slick-slide").css(
        "height",
        $(".slick-slide").closest(".slick-list").height()
      );
    }, 2e3);
    if (!_browserObj.isMobile) {
      TweenMax.set(v.find(".job-wrapper"), { x: _globalViewportW });
      s.init();
      c.init();
      f.init();
      u.init(function () {
  ...
  var H = function () {
    if (!$_body.hasClass("mobile")) {
      ...
      TweenMax.to(w, 1, { y: -w.height() - 50, ease: Power4.easeInOut });
      w.remove();
      p.kill();
      i.kill();
      n.kill();
  ...
  function A() {
    this.init = function () {
      ...
      $.doTimeout(2e3, function () {
        M.to(C.find("path"), 2, {
          morphSVG:
            "M384.7,365.3C276.2,451.3,63.3,270.5,245,127c114.9-90.8,392,14,328.5,145.7C513.5,397.1,472,296,384.7,365.3z",
          repeat: -1,
          yoyo: true,
          ease: Sine.easeInOut,
        });
        e =
          document.querySelector(".place-images").getBoundingClientRect().top +
          document.querySelector(".place-images").getBoundingClientRect()
            .height;
        M.play();
      });
        ...
        C.find("path").hover(
          function () {
            ...
            TweenMax.to(C.find("path"), 2, {
              morphSVG:
                "M194.5,272.7C127,149,337.9-26.9,508.9,135.5C639,259,435,253,383.3,365.3C335.6,469,260.7,393.9,194.5,272.7z",
              ease: Elastic.easeOut.config(1, 0.5),
              onComplete: function () {
                M.stop();
              },
          ...
          function () {
            TweenMax.to(C.find("path"), 2, {
              morphSVG:
                "M384.7,365.3C289.8,466.1,77.4,279,259.1,135.5C374,44.8,623.8,155.2,573.5,272.7C519.2,399.7,462.9,282.2,384.7,365.3z",
              ease: Elastic.easeOut.config(1, 0.5),
              onComplete: function () {
                TweenMax.to(C.find("path"), 2, {
                  morphSVG:
    ...
    this.kill = function () {
      ...
      TweenMax.set(
        [
          ...
          k.find(".cta-bg path"),
          k.find("h3"),
          k.find(".elastic-btn svg"),
          k.find(".elastic-btn span"),
          E,
          E.find(".form-container"),
        ],
        { clearProps: "all" }
      );
    };
  ...
  //       var t = $(e["html"]),
  //         a =
  //           Math.round((v.find(".job-wrapper").length + t.length) / 2) *
  //           (v.find(".job-wrapper").outerHeight() +
  //             parseInt(v.find(".job-wrapper").css("margin-bottom")));
  //       TweenMax.to(v.find(".job-items-wrapper").parent(), 0.5, {
  //         height: a + "px",
  //         ease: Expo.easeOut,
  //         onComplete: function () {
  //           TweenMax.set(t, { opacity: 0, x: _globalViewportW });
  //           v.find(".job-items-wrapper").append(t);
  //           v.attr(
  //             "data-jobsOffset",
  //             Number(v.attr("data-jobsOffset")) +
  //               Number(v.attr("data-jobsPosts"))
  //           );
  //           TweenMax.set(t, { opacity: 1 });
  //           TweenMax.staggerTo(
  //             t,
  //             0.7,
  //             { x: 0, ease: Elastic.easeOut.config(1, 1.5) },
  //             0.05,
  //             function () {
  //               d = true;
  //             }
  ...
  //       });
  //       if (!e["have_next"]) {
  //         TweenMax.to(x, 1, { scale: 0, ease: Elastic.easeIn.config(1, 0.9) });
  //       } else {
  //         TweenMax.to(x, 1, { scale: 1, ease: Elastic.easeIn.config(1, 0.9) });
  //       }
  //     });
  //   });
  ...
  //       ease: Power4.easeInOut,
  //     });
  //     TweenMax.to(l.find(".option-wrapper:not(.active-option)"), 0.5, {
  //       y: "0px",
  //       autoAlpha: 1,
  //     });
  //     TweenMax.to(r, 0.2, { y: "10px", autoAlpha: 0 });
  //     TweenMax.fromTo(
  //       f,
  //       0.2,
  //       { scale: 0, transformOrigin: "center center" },
  //       { scale: 1, transformOrigin: "center center", autoAlpha: 1 }
  //     );
  //     TweenMax.to($(".job-filter-overlay"), 0.2, { autoAlpha: 1 });
  ...
  //       autoAlpha: 0,
  //     });
  //     TweenMax.to(r, 0.2, { y: "0px", autoAlpha: 1 });
  //     TweenMax.fromTo(
  //       f,
  //       0.2,
  ...
  //     );
  //     TweenMax.to($(".job-filter-overlay"), 0.2, {
  //       autoAlpha: 0,
  //       onComplete: function () {
  ...
  //       ease: Elastic.easeOut.config(1, 0.7),
  //     });
  //     TweenMax.to(c.find(".text-wrapper .text"), 0.5, {
  //       y: "100%",
  //       ease: Elastic.easeOut.config(1, 0.7),
  //       onComplete: function () {
  //         TweenMax.set(c.find(".text-wrapper"), { autoAlpha: 0 });
  ...
  //         }
  //       }
  //       TweenMax.to(t.find(".check .stroke"), 0.4, { opacity: 0 });
  //       TweenMax.to(t.find(".check .full"), 0.4, { opacity: 1 });
  //       TweenMax.to(t.find(".check .dash"), 0.4, { strokeDashoffset: 0 });
  //       var r = t.text();
  ...
  //         }
  //       }
  //       TweenMax.to(t.find(".check .stroke"), 0.4, { opacity: 1 });
  //       TweenMax.to(t.find(".check .full"), 0.4, { opacity: 0 });
  //       TweenMax.to(t.find(".check .dash"), 0.4, { strokeDashoffset: u });
  ...
  //       TweenMax.set(t, { opacity: 0, x: _globalViewportW });
  //       TweenMax.staggerTo(
  //         v.find(".job-link:not(.job-spontaneous)"),
  //         1,
  //         { x: _globalViewportW, ease: Elastic.easeIn.config(1, 1.5) },
  //         0.05,
  //         function () {
  //           TweenMax.to(v.find(".job-items-wrapper").parent(), 0.5, {
  //             height: a + "px",
  ...
  //             TweenMax.to(x, 1, {
  //               scale: 0,
  //               ease: Elastic.easeIn.config(1, 0.9),
  //             });
  //           } else {
  //             TweenMax.to(x, 1, {
  //               scale: 1,
  ...
  //       t = false,
  //       a = 0;
  //     for (var o = 0, i = g.length; o < i; o++) if (g[o].values.length) a++;
  //     if (a == 0) {
  ...
  function L(e) {
    if (!_browserObj.isMobile) {
      ...
      if (
        verge.inViewport($(".job-offers"), -_globalViewportH / 3) &&
        !w.hasClass("js-animated")
      ) {
        w.addClass("js-animated");
        TweenMax.to(w, 1, { y: 0, ease: Power4.easeInOut });
      } else if (
        !verge.inViewport($(".job-offers"), -_globalViewportH / 3) &&
        w.hasClass("js-animated")
      ) {
        w.removeClass("js-animated");
        TweenMax.to(w, 1, { y: -w.height() - 150, ease: Power4.easeInOut });
      }
    }
    if (!_browserObj.isMobile) {
      if (!_browserObj.isSafari) {
...
function singleQueremosPage(e) {
  ...
  var m = $(".full-page-container"),
    ...
    x = $(".load-next-wrapper");
  if (!$_body.hasClass("mobile")) {
    u = Scrollbar.init(t[0], { speed: 0.8, syncCallbacks: true });
  ...
  var o = function () {
    ...
    $_headerMain
      .find("#nav-main li[data-controller='queremos-te-page']")
      .addClass("active");
    $_body.detach(".rotate-title-fixed");
    a.each(function () {
      var e = $(this);
  ...
  function T(e) {
    ...
    $.get(t, function (e) {
      ...
      $(".iframe-embed")
        .find("iframe")
        .attr("width", $(".iframe-embed").width())
        .attr("height", $(".iframe-embed").width() / r);
      TweenMax.to($(".iframe-embed"), 0.2, { opacity: 1 });
      $.doTimeout(1e3, function () {
        _customScroll.unregisterEvents(/scroll/, /wheel/, /touchstart/);
        _customScroll.update();
  ...
  function M(e) {
    ...
    if (!_browserObj.isMobile) {
      for (var t = 0, a = c.length; t < a; t++) {
        if (_scrollDirection == "down") {
          if (
            c[t].offsetY <= e.offset.y &&
            c[t].element.offset().top > 0 &&
            c[t].element.offset().top < _globalViewportH
          ) {
          ...
          if (
            c[t].offsetY <= e.offset.y &&
            c[t].element.offset().top + c[t].height > _globalViewportH &&
            c[t].element.offset().top < _globalViewportH
          ) {
            m.attr("data-activeJob", c[t].element.attr("data-id"));
            y();
      ...
      if (e.offset.y >= e.limit.y) {
        if (f) {
          ...
          $_window.on("mousewheel.scrollNextJob", function (e) {
            ...
            TweenMax.set(x.find(".indicator"), { scaleX: l });
            if (l > 1) {
              l = 1;
              d = true;
              ...
              T();
              TweenMax.staggerTo(
                [x.find(".indicator-wrapper"), x.find("p")],
                1,
                { y: "-25px", opacity: 0, ease: Back.easeOut },
                0.05
              );
        ...
        TweenMax.to(x.find(".indicator"), 1, { scaleX: 0, ease: Expo.easeOut });
      }
    }
    var o = g.offset().top,
      i =
        $(".full-page-article-header").offset().top +
        $(".full-page-article-header").height() +
        110;
    if (g.hasClass("js-fix-me")) TweenMax.set(g, { top: e.offset.y + "px" });
    if (o <= 0) {
      g.addClass("js-fix-me");
...
function singleServicePage() {
  ...
  if ($_body.hasClass("nearshoring")) {
    ...
    var S = new GlAnimation({
      ...
      objExtra2_ScaleMaxDesktop: 0.04,
      objExtra2_Y_ScaleMaxDesktop: -26,
      objGroupX_MaxDesktop: 0,
      objGroupY_MaxDesktop: 1.2,
      objGroupZ_MaxDesktop: 0,
  ...
  var we = function () {
    ...
    $_body.append(b);
    $_headerMain
      .find("#nav-main li[data-controller='fazemos-page']")
      .addClass("active");
    $_headerMain
      .find("#nav-main-mobile li[data-controller='fazemos-page']")
      .addClass("active");
    ...
    if (!$_body.hasClass("mobile")) {
      TweenMax.to($_body.find(".main-logo"), 0.5, { opacity: 1 });
      TweenMax.to($_body.find(".language-wrapper"), 0.5, { opacity: 1 });
      TweenMax.to($_pageHeader.find(".background-image"), 0.5, { opacity: 1 });
      if ($_body.hasClass("js-no-ajax")) {
        S.init();
      } else {
    ...
    f.find("li").on("click", function () {
      ...
      if (y) {
        ...
        e.addClass("active");
        TweenMax.staggerTo(
          $(".conditions-wrapper").filter(".active").find(".condition"),
          0.6,
          { y: 50, opacity: 0, ease: Elastic.easeInOut.config(1, 0.8) },
          0.1,
          function () {
        ...
        TweenMax.staggerTo(
          $("." + t + "").find(".condition"),
          0.6,
          { y: 0, opacity: 1, ease: Elastic.easeInOut.config(1, 0.8) },
          0.1,
          function () {
            setTimeout(function () {
              $("." + t + "").addClass("active");
    ...
    if (!$_body.hasClass("mobile")) {
      ...
      n.find("li").each(function () {
        ...
        TweenMax.set(e.find("p"), { y: "40px", opacity: 0 });
      });
    }
  ...
  function be() {
    ...
    var u = function () {
      ...
      o.each(function () {
        ...
        e.css({ left: $(this).outerWidth() * t - d * t });
      });
      e.hover(
        function () {
          var e = $(this);
      ...
      e.on("mouseleave", function () {
        ...
        if (f < t && p == "right") {
          f++;
          TweenMax.to(a.find(".clients-wrapper"), 0.6, {
            x: "+=" + (-o.outerWidth() + d),
            ease: Power2.easeOut,
          });
        ...
        if (f < 1) {
          ...
          TweenMax.to(n, 1, { autoAlpha: 0, ease: Power2.easeOut });
          TweenMax.to(n.find("svg"), 0.3, {
            x: 0,
            force3D: true,
            ease: Power2.easeOut,
          });
          TweenMax.to(n.find("h4"), 0.3, {
            x: 0,
            force3D: true,
            ease: Power2.easeOut,
          });
        ...
        if (f > 0) {
          ...
          TweenMax.to(n, 1, { autoAlpha: 1, ease: Power2.easeOut });
        }
        if (f > t - 2) {
          TweenMax.to($(".blob-right"), 1, {
            x: 450,
          ...
          TweenMax.to(i, 1, { autoAlpha: 0, ease: Power2.easeOut });
          TweenMax.to(i.find("svg"), 0.3, {
            x: 0,
            force3D: true,
            ease: Power2.easeOut,
          });
          TweenMax.to(i.find("h4"), 0.3, {
            x: 0,
            force3D: true,
            ease: Power2.easeOut,
          });
        } else {
          TweenMax.to(i, 1, { autoAlpha: 1, ease: Power2.easeOut });
        }
        r = 0;
        s = false;
      });
      e.on("mousedown", function (e) {
        ...
        TweenMax.to(t.find("path"), 1, {
          morphSVG:
            "M.4 336.83C12 50.47 263 8.05 493 .28S915 146.62 921.65 344.5 747.26 708.75 517.24 716.87C268.47 725.64-12 643.92.4 336.83z",
          ease: Expo.easeOut,
        });
      });
      ...
      e.on("mousemove", function (e) {
        ...
        if (s) {
          if (p == "right") {
            ...
            r = c;
            TweenMax.to(t, 0.3, { x: -r, force3D: true, ease: Power2.easeOut });
            TweenMax.to(i.find("svg"), 0.3, {
              x: -(r + r / 2),
              force3D: true,
              ease: Power2.easeOut,
    ...
    var u = function () {
      ...
      if ($_body.hasClass("phone")) {
        setTimeout(function () {
          $(".clients-wrapper").css({
            height:
              e.find("article").first().find("li").first().outerHeight() * 7 +
              "px",
          });
        }, 4e3);
      } else {
      ...
      a.on("swiperight", function () {
        if (f > 0) {
          f--;
          TweenMax.to(e.find(".clients-wrapper"), 0.6, {
            x: "-=" + (-a.outerWidth() + d),
            ease: Power2.easeOut,
          });
          e.find("article.active").removeClass("active");
          e.find("article").eq(f).addClass("active");
          TweenMax.to(o, 0.6, { autoAlpha: 1, ease: Power2.easeOut });
        }
        if (f == 0) {
          TweenMax.to(i, 0.6, { autoAlpha: 0, ease: Power2.easeOut });
        }
      });
      a.on("swipeleft", function () {
        if (f < n - 1) {
          ...
          e.find("article.active").removeClass("active");
          e.find("article").eq(f).addClass("active");
          TweenMax.to(i, 0.6, { autoAlpha: 1, ease: Power2.easeOut });
        }
        if (f == n - 1) {
          TweenMax.to(o, 0.6, { autoAlpha: 0, ease: Power2.easeOut });
        }
      });
    };
    u();
  ...
  function _e() {
    this.init = function () {
      TweenMax.set(de.find("svg path"), { strokeDashoffset: he });
      TweenMax.set(de.find("svg path"), { strokeDasharray: he });
      le.each(function (e) {
        var t = $(this),
          a = {};
        a.element = t;
    ...
    this.animate = function (e) {
      if (e > ge - _globalViewportH / 2 && e < ge + me - _globalViewportH / 2) {
        var t =
          he -
          normalizedValue(_scrollY - ge + _globalViewportH / 2, me, 0) * he;
        TweenMax.set(de.find("svg path"), { strokeDashoffset: t });
        if (t <= 0) {
          de.addClass("done");
          return false;
        }
  ...
  function ye() {
    ...
    this.show = function () {
      TweenMax.staggerTo(
        h.find("li"),
        1,
        { y: 0, ease: Elastic.easeOut.config(1, 0.8) },
        0.1
      );
      h.addClass("enable");
    };
    this.hide = function () {
      TweenMax.staggerTo(
        h.find("li"),
        1,
        { y: -200, ease: Elastic.easeOut.config(1, 0.8) },
        0.1
      );
  ...
  function $e() {
    this.init = function () {
      ...
      L.on("keydown", function () {
        ...
        if (_browserObj.isPhone) {
          TweenMax.set(P, { y: _scrollY + _globalViewportH - P.outerHeight() });
        }
      });
      ...
      X.on("click", function () {
        ...
        if ($.trim(e.closest(R).find("input").val()).length == 0) {
          ...
          if (k) {
            ...
            e.closest(R).attr(
              "data-text",
              $.trim(e.closest(R).find("input").val())
            );
              ...
              if (ne <= _globalViewportH * 0.7) {
                ...
                if (!_browserObj.isMobile) {
                  if (!$_html.hasClass("edge") || !$_html.hasClass("ie")) {
                    TweenMax.to(P, 1, {
                      top:
                        _scrollY + _globalViewportH - P.outerHeight() - 125 - K,
                      ease: Elastic.easeOut.config(1, 0.7),
                    });
                  } else {
                    TweenMax.to(P, 1, {
      ...
      H.on("click", function () {
        ...
        if (!T) {
          ...
          TweenMax.to(P.find(".form-container"), 0.1, {
            ease: Elastic.easeOut.config(1, 0.7),
            autoAlpha: 0,
            scale: 0.9,
            force3D: true,
        ...
        if (T) {
          if (W.hasClass("show")) {
            TweenMax.to(W, 1, {
              ...
              scale: 0.9,
              className: "-=show",
              ease: Elastic.easeOut.config(1, 0.07),
            });
          }
          T = false;
          oe = true;
            ...
            if (_scrollY > 0) {
              TweenMax.set(P, {
                y:
                  _scrollY +
                  _globalViewportH -
                  P.find("form").outerHeight() -
                  $_headerMain.outerHeight(),
              });
            }
          }
        }
      ...
      P.find(".project-form").on("submit", function (e) {
        ...
        e.stopPropagation();
        if (
          validateForm(P.find(".project-form")) &&
          !P.find(".project-form").hasClass("sending") &&
          j
        ) {
          P.find(".project-form").addClass("sending");
          R.find("input").css("pointer-events", "none");
          V.css("pointer-events", "none");
          TweenMax.to(I.find(".morph-bg"), 0.4, {
            opacity: 0,
            ease: Elastic.easeOut.config(1, 0.7),
          });
          TweenMax.to(I.find(".arrow"), 0.4, {
            opacity: 0,
            ease: Elastic.easeOut.config(1, 0.7),
          });
          TweenMax.to(I.find(".text"), 0.4, {
            opacity: 0,
            ease: Elastic.easeOut.config(1, 0.7),
          });
          TweenMax.to(N, 1, {
          ...
          var a = {
            _wp_http_referer: P.find(".project-form")
              .find("input[name='_wp_http_referer']")
              .val(),
            affinity_nonce: P.find(".project-form")
              .find("input[name='affinity_nonce']")
              .val(),
            ...
            project_city: P.find(".project-form")
              .find("#location")
              .attr("data-final-city"),
          ...
          function o() {
            ...
            $.doTimeout(1e3, function () {
              if (!_browserObj.isMobile) {
                P.css(
                  "top",
                  _scrollY + _globalViewportH - P.outerHeight() - 125
                );
              } else {
                TweenMax.to(P, 1, {
                  y: 0,
    ...
    this.kill = function () {
      ...
      TweenMax.set(
        [
          ...
          A.find("h3"),
          H,
          A.find(".elastic-btn svg"),
          A.find(".elastic-btn span"),
          P,
          P.find(".form-container"),
          I.find(".morph-bg"),
          I.find(".arrow"),
          I.find(".text"),
          N,
  ...
  function Te() {
    ...
    var i = function () {
      ...
      if (d.find(".case-item").length > 1) {
        TweenMax.to(l.filter(".next-slide").find("svg path"), 0.5, {
          morphSVG: h.all[h.next].morph_path,
          ease: Elastic.easeOut.config(1, 0.8),
        });
        l.filter(".next-slide")
          .find("svg path")
          .attr("data-current", h.all[h.next].morph_path);
        ...
        TweenMax.set(l.filter(".next-slide"), { autoAlpha: 0 });
      }
      TweenMax.set(r.find(".case-letter"), { scale: 0 });
      r.find(".case-study-image").prepend(t);
      TweenMax.set(l.filter(".prev-slide"), { x: "-120%" });
      if (v) {
        m(
          $(".case-studies-lightbox-content li[data-slug='" + v + "']").attr(
            "data-id"
          )
        );
      }
      ...
      l.on("mouseenter", function () {
        ...
        TweenMax.to(e.find("svg path"), 1, {
          morphSVG:
            "M7.738,102.134c4.597,61.825,41.883,70.919,91.681,70.919c49.797,0,73.231-34.722,73.231-77.552 c0-42.833-23.435-77.479-73.231-77.553C45.564,17.868,2.805,35.829,7.738,102.134z",
          ease: Elastic.easeOut.config(1, 0.8),
        });
      });
    ...
    var s = function (e, t) {
      ...
      TweenMax.to(
        [
          r.find(".case-study-info .case-subject"),
          r.find(".case-study-info .case-title"),
          r.find(".case-study-info .case-text"),
        ],
        1,
        {
          y: "-20px",
          ...
          onComplete: function () {
            ...
            TweenMax.set([i, n, s], { opacity: 0, y: "20px" });
            ...
            TweenMax.to(
              ...
              1,
              { opacity: 1, y: "0px", ease: Power4.easeOut }
            );
          },
        }
      );
      if (t == "next") {
        if (h.next != null) {
          ...
          if (h.total - 1 == e) {
            ...
            l.filter(".next-slide")
              .find("svg path")
              .attr("data-current", h.all[h.next].morph_path);
            TweenMax.to(l.filter(".next-slide").find("h3"), 0.5, {
              y: "-10px",
              opacity: 0,
              ease: Power4.easeOut,
              onComplete: function () {
                l.filter(".next-slide")
                  .find("h3")
                  .text(h.all[h.next].case_title);
                TweenMax.fromTo(
                  l.filter(".next-slide").find("h3"),
                  0.5,
                  { y: "5px", opacity: 0 },
                  { y: "0px", opacity: 1, ease: Power4.easeOut }
                );
              },
            });
          }
          ...
          l.filter(".prev-slide")
            .find("svg path")
            .attr("data-current", h.all[h.prev].morph_path);
          TweenMax.to(l.filter(".prev-slide").find("h3"), 0.25, {
            y: "-5px",
            opacity: 0,
            ease: Power4.easeOut,
            onComplete: function () {
        ...
        TweenMax.fromTo(
          $(".case-study-image .case-background-morph"),
          1,
          { x: "0%" },
          {
            x: "-100%",
            ease: Expo.easeOut,
            onComplete: function () {
              r.find(".block-bg-cover picture img").attr(
                "src",
                h.all[h.active].image
              );
              TweenMax.to(
                $(".case-study-image .case-background-morph .letter-morph"),
                1.5,
                {
                  morphSVG: $(
                    ".case-study-image .case-background-morph .letter-morph"
        ...
        if (h.prev != null) {
          ...
          l.filter(".next-slide")
            ...
            .attr("data-current", h.all[h.next].morph_path);
          l.filter(".next-slide").attr("data-id", h.next);
          TweenMax.to(l.filter(".next-slide").find("h3"), 0.25, {
            y: "-5px",
            opacity: 0,
            ease: Power4.easeOut,
            onComplete: function () {
      ...
      TweenMax.to(
        ...
        {
          morphSVG: $(
            ".case-study-image .case-background-morph .background-rect"
          ),
          ease: Expo.easeOut,
        }
      );
    ...
    var m = function (e) {
      var t = $(".cases-studies ul li.active"),
        ...
        i =
          _scrollY +
          t.find(".case-study-image img").offset().top -
          (_globalViewportH - t.find(".case-study-image img").height()) / 2,
        n = null;
      ...
      if (
        ...
        $(".gradient").css(
          "top",
          _globalViewportH - $(".gradient").outerHeight()
        );
        _customScroll.unregisterEvents(/scroll/, /wheel/, /touchstart/);
      } else {
        TweenMax.set(".gradient", { autoAlpha: 1 });
      }
      if (_customScroll == null) {
      } else {
        _customScroll.unregisterEvents(/scroll/, /wheel/, /touchstart/);
      ...
      if (p == null) {
        ...
        $_window[0].addEventListener("scroll", s, { passive: true });
        var r = { offset: { y: -1 } };
      ...
      function l(e) {
        if (
          ...
          $(".gradient").css(
            "top",
            e.offset.y + (_globalViewportH - $(".gradient").outerHeight())
          );
        }
        if (_scrollY > 10) {
      ...
      o = $(".fazemos-lightbox .case-images-container .slider");
      o.slick({ dots: true, arrows: true });
      $(".slick-arrow.slick-next").html(
        "<svg viewBox='0 0 67.69 62.47'><path d='M33.37 2.12c14-.74 28.83 1.33 32 26.33s-17.17 31.84-28.67 32-31.17-.5-34.33-27 14.93-30.48 31-31.33z' stroke-miterlimit='10' stroke-width='5' fill='none' stroke='#2a6ff3'/><path stroke-linecap='round' stroke-linejoin='round' stroke-width='5' fill='none' stroke='#2a6ff3' d='M27.01 18.39l13.67 12.22-11.8 13.46'/></svg>"
      );
      $(".slick-arrow.slick-prev").html(
        "<svg viewBox='0 0 67.69 62.47'><path d='M34.33 2.12c-14-.74-28.83 1.33-32 26.33S19.5 60.29 31 60.45s31.17-.5 34.33-27-14.93-30.48-31-31.33z' stroke-miterlimit='10' stroke-width='5' fill='none' stroke='#2a6ff3'/><path stroke-linecap='round' stroke-linejoin='round' stroke-width='5' fill='none' stroke='#2a6ff3' d='M40.68 18.39L27.01 30.61l11.81 13.46'/></svg>"
      );
      TweenMax.set(f, { x: _globalViewportW, autoAlpha: 1 });
      TweenMax.to(b, 1, { y: -b.height() - 50, ease: Power4.easeInOut });
      TweenMax.to(f, 1.5, {
        x: 0,
        delay: 1,
        ease: Power4.easeOut,
      ...
      TweenMax.to(c, 1.7, { x: "-100px", delay: 1, ease: Expo.easeOut });
      TweenMax.to(
        $(".fazemos-lightbox .case-background-morph .letter-morph"),
        2,
        {
          morphSVG: $(
    ...
    var g = function () {
      ...
      if (!$_html.hasClass("ie") && !$_html.hasClass("edge")) {
        ...
        if (_scrollY > _globalViewportH) {
          TweenMax.to(b, 1, { y: 0, ease: Power4.easeInOut });
        }
      } else {
        TweenMax.set(".gradient", { autoAlpha: 0 });
        $_body.css({ overflow: "visible", height: "auto" });
        $_html.css({ overflow: "visible", height: "auto" });
      }
      history.pushState({}, {}, window.location.pathname);
      TweenMax.to(f, 1.5, { x: _globalViewportW, ease: Expo.easeOut });
      TweenMax.to(c, 1.7, {
        x: "0px",
        ease: Expo.easeOut,
        onComplete: function () {
      ...
      TweenMax.to($(".case-background-morph .letter-morph"), 2, {
        morphSVG: $(".case-background-morph .letter-morph").attr(
          "data-original"
        ),
        ease: Expo.easeOut,
      });
      TweenMax.to($(".fazemos-lightbox .slider"), 0.2, { y: 20, autoAlpha: 0 });
      $(document).off("keydown.casesLightbox");
    };
    var w = function () {
      $(document).off("keydown.casesSlider");
    };
    return { init: i, kill: w, open: m, animate: n };
  }
  function Me(n) {
    var e = 20;
    var s;
    ...
    var g = new PIXI.Application(h, m, { transparent: true }),
      w = null,
      v = null,
      b = null;
    var o = function () {
      ...
      e.load(function () {
        ...
        v.width = h;
        v.height = m;
        TweenMax.set(v.scale, { x: 0.98, y: 0.98 });
        TweenMax.set(v, { alpha: 0 });
        g.stage.addChild(v);
        TweenMax.to(v.scale, 0.5, { x: 1, y: 1, ease: Expo.easeOut });
        TweenMax.to(v, 0.5, { alpha: 1 });
        g.start();
      ...
      function o() {
        ...
        w.width = h;
        w.height = m;
        TweenMax.set(w.scale, { x: 0.98, y: 0.98 });
        TweenMax.set(w, { alpha: 0 });
        g.stage.addChild(w);
        TweenMax.to(w.scale, 0.5, { x: 1, y: 1, ease: Expo.easeOut });
        TweenMax.to(w, 0.5, {
          alpha: 1,
          onComplete: function () {
            g.start();
    ...
    return { init: o, kill: x };
  }
  function ke() {
    var a = $(".technologies"),
      e = $(".technologies-list");
    if ($_body.hasClass("mobile")) return;
    var t = { rootMargin: "0px", threshold: [0.25] };
    var o = function (e, t) {
      e.forEach(function (e) {
        if (e.isIntersecting || e.intersectionRatio > 0) {
          t.unobserve(e.target);
    ...
    TweenMax.set(a.find(".column"), { y: "150px", opacity: 0 });
    i.observe(a[0]);
  ...
  function je() {
    ...
    s.on("click", function () {
      ...
      if (!w) {
        ...
        l.append(i);
        TweenMax.set(l.find(".js-main-text"), { opacity: 0 });
        TweenMax.to(l.find(".js-aux-text"), 1, {
          ...
          onComplete: function () {
            ...
            l.find(".js-aux-text")
              .attr("style", "")
              .removeClass("js-aux-text")
              .addClass("js-main-text");
            w = false;
          },
        });
        if ($_window.width() <= 768) {
        ...
        TweenMax.set(e.find("p"), { y: "40px", opacity: 0 });
        TweenMax.to(r.filter(".active"), 0.1, {
          y: "40px",
          opacity: 0,
          onComplete: function () {
            TweenMax.fromTo(
  ...
  function Ee(e) {
    ...
    if (_scrollDirection == "down") {
      if (
        ...
        _scrollY < _scrollLimit - _globalViewportH &&
        !b.hasClass("js-animated")
      ) {
    ...
    if (!_browserObj.isPhone) {
      ...
      if (
        verge.inViewport(U, -150) &&
        !U.hasClass("js-animated") &&
        !$_body.hasClass("mobile")
      ) {
    ...
    if (_browserObj.isPhone) {
      if (
        b.hasClass("js-animated") &&
        P.find(".project-form").hasClass("js-open-form")
      ) {
        TweenMax.to(b, 1, {
          y: -b.height() - 50,
          ease: Elastic.easeOut.config(1, 0.7),
    ...
    if (verge.inViewport(n) && !n.hasClass("js-animated")) {
      ...
      TweenMax.staggerTo(
        n.find("svg path"),
        2,
        { "stroke-dashoffset": 0, ease: Expo.easeInOut },
        0.15
      );
      TweenMax.staggerTo(
        n.find("p"),
        2,
        { y: "0px", opacity: 1, delay: 0.1, ease: Expo.easeInOut },
        0.18
      );
    }
  }
  return { init: we, kill: ve };
}
function somosPage(e) {
  ...
  var o = 0,
    ...
    b = new GlAnimation({
      ...
      desktopMaxWidth: 1440,
      objsGroup_ScaleDesktop: 1,
      objLetter_ScaleDesktop: 0.78,
      objGroupX_desktop: 0,
      objGroupY_desktop: 1.2,
      objGroupZ_desktop: 0,
      desktopMaxMaxWidth: 1800,
      objsGroup_ScaleMaxDesktop: 1,
      objLetter_ScaleMaxDesktop: 0.78,
      objGroupX_MaxDesktop: 0,
      objGroupY_MaxDesktop: 1.2,
      objGroupZ_MaxDesktop: 0,
      objWidthBigDesktop: 1,
      objLetter_ScaleBigDesktop: 0.78,
      objGroupX_bigDesktop: 0,
      objGroupY_bigDesktop: 1.2,
      objGroupZ_bigDesktop: 0,
      aniTime: 1.2,
  ...
  var H = function () {
    ...
    if ($_body.hasClass("mobile") && $_window.width() <= 1024) {
      $(".somos-page .mission h2").html(
        '<span class="firstwrap">A Lifetime</span><span class="secondwrap">Experience.</span>'
      );
    }
  };
  var A = function () {
  ...
  function L() {
    ...
    var e = function (e) {
      ...
      $(f).attr(
        "viewBox",
        "0 0 " + $(i).outerWidth() + " " + $(i).outerHeight() + ""
      );
      if (!_browserObj.isMobile) {
      ...
      setTimeout(function () {
        ...
        for (var o = 0; o < c.length; o++) {
          w("circle", f, { cx: c[o].x, cy: c[o].y, r: 7 });
        }
      }, 1e3);
      Draggable.create(i, {
        type: "x",
        ...
        onPress: function () {
          if (!_browserObj.isMobile) {
            TweenMax.to(".timeline-helper .background", 0.6, {
              scale: 1.2,
              ease: Power4.easeOut,
            });
          }
  ...
  function I() {
    ...
    var p = function () {
      ...
      if (window.innerWidth > 1080) {
        $(".social-articles-wrapper .article").hover(
          function () {
            var e = $(this);
        ...
        VirtualScroll.on(function (e) {
          ...
          if (Math.floor(g / 5) < 0 && Math.floor(-g / 5) < o - i - s + 90) {
            TweenMax.to(".social-articles-wrapper", 0.6, {
              x: g / 5,
              ease: "Power4.easeOut",
            });
          }
    ...
    function u() {
      a = _rAF_loop(u);
      if (
        (_scrollY + window.innerHeight > l + c && v) ||
        (_scrollY + window.innerHeight < l + c && f)
      ) {
    ...
    var h = function (e, t) {
      ...
      if (
        t == "up" &&
        _scrollY + window.innerHeight > l + c + 100 &&
        !f &&
        !w
      ) {
        f = true;
    ...
    return { init: p, onScroll: h, kill: m };
  }
  function V() {
    ...
    t.on("mouseenter", function () {
      ...
      TweenMax.to(e.find(".plus-button"), 0.4, {
        scale: 1,
        rotation: 360,
        ease: Expo.easeOut,
      });
    ...
    t.on("click", function () {
      ...
      if (e.hasClass("js-open")) {
        if (_customScroll != null) {
          _customScroll.scrollTo(
            0,
            e.offset().top + _customScroll.offset.y - 60,
            700,
            function () {
              _customScroll.unregisterEvents(/scroll/, /wheel/, /touchstart/);
              TweenMax.set($(".affinity-brands").find(".overlay"), {
                top: _scrollY + "px",
                onComplete: function () {
                  TweenMax.to($(".affinity-brands").find(".overlay"), 0.4, {
                    autoAlpha: 1,
                  });
                },
              });
          ...
          TweenMax.to($_window, 1, {
            scrollTo: { y: e.offset().top - 60 },
            ease: Power4.easeOut,
          });
        }
        if (e.data("real-height-block") > _globalViewportH * 0.8) {
          n = Scrollbar.init(t[0], { speed: 0.8 });
          ...
          TweenMax.to(e.find(".gradient-block"), 0.4, {
            height: o - 150,
            ease: Expo.easeOut,
          });
        } else {
        ...
        TweenMax.set(e.find(".gradient"), { opacity: 0 });
      } else {
        if (_customScroll != null)
          _customScroll.registerEvents(/scroll/, /wheel/, /touchstart/);
        if (n != null) {
        ...
        TweenMax.to(e.find(".gradient-block"), 0.2, {
          height: 250,
          overflow: "hidden",
        });
        TweenMax.set(e.find(".gradient"), { opacity: 1 });
        TweenMax.to(e.find(".plus-button"), 0.4, {
          scale: 0,
          rotation: 0,
          ease: Expo.easeOut,
  ...
  function F() {
    var a = $(".clients");
    var e = { rootMargin: "0px", threshold: [0.25] };
    if ($_body.hasClass("mobile")) return;
    var t = function (e, t) {
      e.forEach(function (e) {
        if (e.isIntersecting || e.intersectionRatio > 0) {
    ...
    TweenMax.set(a.find(".column"), { opacity: 0, y: 40 });
    o.observe(a[0]);
  }
  function R() {
    x.each(function () {
  ...
  function G() {
    ...
    a.find("input").on("focus", function () {
      TweenMax.staggerTo(a.find("label"), 0.5, {
        opacity: 0,
        ease: Expo.easeOut,
      });
    });
    ...
    a.on("submit", function (e) {
      ...
      a.find("button")[0]
        .path_line.stop()
        .animate({ path: a.find("button").data("normal") }, 1e3, mina.elastic);
    });
  }
  function B() {
    var e = $(".team-person-container");
    e.each(function () {
      ...
      TweenMax.set(e.find("svg"), { opacity: 0, scale: 0 });
    });
    e.on("mousemove", function (e) {
      var t = $(this).find("svg");
      var a =
    ...
    e.on("mouseleave", function () {
      ...
      TweenMax.to(e, 0.2, { opacity: 0, scale: 0 });
      TweenMax.to(e.find("path"), 1, {
  ...
  function Y() {
    ...
    var e = function () {
      $_window.on("resize.carouselClients", $.debounce(1e3, m));
      TweenMax.set(i, { y: (a.outerHeight() - i.outerHeight()) / 2 });
      ...
      o.each(function () {
        ...
        e.css({ left: $(this).outerWidth() * t - p * t });
      });
      i.hover(
        function () {
          var e = $(this);
      ...
      i.on("mouseleave", function () {
        ...
        if (d < 1) {
          ...
          TweenMax.to(s, 1, { autoAlpha: 0, ease: Power2.easeOut });
          TweenMax.to(s.find("svg"), 0.3, {
            x: 0,
            force3D: true,
            ease: Power2.easeOut,
          });
          TweenMax.to(s.find("h4"), 0.3, {
            x: 0,
            force3D: true,
            ease: Power2.easeOut,
          });
        ...
        if (d > 0) {
          ...
          TweenMax.to(s, 1, { autoAlpha: 1, ease: Power2.easeOut });
        }
        if (d > t - 2) {
          TweenMax.to($(".blob-right"), 1, {
            x: 450,
      ...
      i.on("mousemove", function (e) {
        ...
        if (r) {
          if (u == "right") {
            ...
            l = f;
            TweenMax.to(t, 0.3, { x: -l, force3D: true, ease: Power2.easeOut });
            TweenMax.to(n.find("svg"), 0.3, {
              x: -(l + l / 2),
              force3D: true,
              ease: Power2.easeOut,
    ...
    function e() {
      ...
      C.each(function (e) {
        ...
        if (e == 3) {
          a.offset =
            t.offset().top -
            parseInt(j.css("paddingTop")) -
            parseInt(j.css("paddingBottom"));
        } else {
          a.offset = t.offset().top;
        }
        a.height = t.outerHeight(true);
  ...
  function q(e) {
    ...
    if (!_browserObj.isPhone) {
      ...
      if (
        verge.inViewport(S, -_globalViewportH / 3) &&
        !S.hasClass("js-animated-2")
      ) {
